...
const (
	...
	Debug_GetSemaphoreLevel_FullMethodName         = "/debug.v1.Debug/GetSemaphoreLevel"
	Debug_GetAppSemaphoreLevel_FullMethodName      = "/debug.v1.Debug/GetAppSemaphoreLevel"
	Debug_GetFunctionSemaphoreLevel_FullMethodName = "/debug.v1.Debug/GetFunctionSemaphoreLevel"
	Debug_SetSemaphoreLevel_FullMethodName         = "/debug.v1.Debug/SetSemaphoreLevel"
	Debug_SetAppSemaphoreLevel_FullMethodName      = "/debug.v1.Debug/SetAppSemaphoreLevel"
	Debug_SetFunctionSemaphoreLevel_FullMethodName = "/debug.v1.Debug/SetFunctionSemaphoreLevel"
...
type DebugClient interface {
	...
	GetSemaphoreLevel(ctx context.Context, in *SemaphoreLevelRequest, opts ...grpc.CallOption) (*SemaphoreLevelResponse, error)
	// GetAppSemaphoreLevel reads the worker concurrency semaphore for an app.
	GetAppSemaphoreLevel(ctx context.Context, in *AppSemaphoreLevelRequest, opts ...grpc.CallOption) (*SemaphoreLevelResponse, error)
	// GetFunctionSemaphoreLevel reads the function concurrency semaphore for a function.
	GetFunctionSemaphoreLevel(ctx context.Context, in *FunctionSemaphoreLevelRequest, opts ...grpc.CallOption) (*SemaphoreLevelResponse, error)
	// SetSemaphoreLevel overrides capacity for a single account-scoped semaphore by explicit name.
	SetSemaphoreLevel(ctx context.Context, in *SetSemaphoreLevelRequest, opts ...grpc.CallOption) (*SetSemaphoreLevelResponse, error)
	// SetAppSemaphoreLevel overrides worker concurrency capacity for an app.
	SetAppSemaphoreLevel(ctx context.Context, in *SetAppSemaphoreLevelRequest, opts ...grpc.CallOption) (*SetSemaphoreLevelResponse, error)
	// SetFunctionSemaphoreLevel overrides function concurrency capacity for a function.
	SetFunctionSemaphoreLevel(ctx context.Context, in *SetFunctionSemaphoreLevelRequest, opts ...grpc.CallOption) (*SetSemaphoreLevelResponse, error)
...
func (c *debugClient) GetSemaphoreLevel(ctx context.Context, in *SemaphoreLevelRequest, opts ...grpc.CallOption) (*SemaphoreLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SemaphoreLevelResponse)
	err := c.cc.Invoke(ctx, Debug_GetSemaphoreLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *debugClient) GetAppSemaphoreLevel(ctx context.Context, in *AppSemaphoreLevelRequest, opts ...grpc.CallOption) (*SemaphoreLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SemaphoreLevelResponse)
	err := c.cc.Invoke(ctx, Debug_GetAppSemaphoreLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *debugClient) GetFunctionSemaphoreLevel(ctx context.Context, in *FunctionSemaphoreLevelRequest, opts ...grpc.CallOption) (*SemaphoreLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SemaphoreLevelResponse)
	err := c.cc.Invoke(ctx, Debug_GetFunctionSemaphoreLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *debugClient) SetSemaphoreLevel(ctx context.Context, in *SetSemaphoreLevelRequest, opts ...grpc.CallOption) (*SetSemaphoreLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetSemaphoreLevelResponse)
	err := c.cc.Invoke(ctx, Debug_SetSemaphoreLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *debugClient) SetAppSemaphoreLevel(ctx context.Context, in *SetAppSemaphoreLevelRequest, opts ...grpc.CallOption) (*SetSemaphoreLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetSemaphoreLevelResponse)
	err := c.cc.Invoke(ctx, Debug_SetAppSemaphoreLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *debugClient) SetFunctionSemaphoreLevel(ctx context.Context, in *SetFunctionSemaphoreLevelRequest, opts ...grpc.CallOption) (*SetSemaphoreLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetSemaphoreLevelResponse)
	err := c.cc.Invoke(ctx, Debug_SetFunctionSemaphoreLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DebugServer interface {
	...
	// GetSemaphoreLevel reads a single account-scoped semaphore by explicit name.
	GetSemaphoreLevel(context.Context, *SemaphoreLevelRequest) (*SemaphoreLevelResponse, error)
	// GetAppSemaphoreLevel reads the worker concurrency semaphore for an app.
	GetAppSemaphoreLevel(context.Context, *AppSemaphoreLevelRequest) (*SemaphoreLevelResponse, error)
	// GetFunctionSemaphoreLevel reads the function concurrency semaphore for a function.
	GetFunctionSemaphoreLevel(context.Context, *FunctionSemaphoreLevelRequest) (*SemaphoreLevelResponse, error)
	// SetSemaphoreLevel overrides capacity for a single account-scoped semaphore by explicit name.
	SetSemaphoreLevel(context.Context, *SetSemaphoreLevelRequest) (*SetSemaphoreLevelResponse, error)
	// SetAppSemaphoreLevel overrides worker concurrency capacity for an app.
	SetAppSemaphoreLevel(context.Context, *SetAppSemaphoreLevelRequest) (*SetSemaphoreLevelResponse, error)
	// SetFunctionSemaphoreLevel overrides function concurrency capacity for a function.
	SetFunctionSemaphoreLevel(context.Context, *SetFunctionSemaphoreLevelRequest) (*SetSemaphoreLevelResponse, error)
	// GetBatchInfo retrieves information about the current batch for a function and batch key.
...
func (UnimplementedDebugServer) GetPartitionStatus(context.Context, *PartitionRequest) (*PartitionStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPartitionStatus not implemented")
}
func (UnimplementedDebugServer) GetQueueItem(context.Context, *QueueItemRequest) (*QueueItemResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetQueueItem not implemented")
}
func (UnimplementedDebugServer) GetPause(context.Context, *PauseRequest) (*PauseResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPause not implemented")
}
...
func (UnimplementedDebugServer) BlockPeek(context.Context, *BlockPeekRequest) (*BlockPeekResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BlockPeek not implemented")
}
func (UnimplementedDebugServer) BlockDeleted(context.Context, *BlockDeletedRequest) (*BlockDeletedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BlockDeleted not implemented")
}
func (UnimplementedDebugServer) CheckConstraints(context.Context, *v1.CapacityCheckRequest) (*CheckConstraintsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckConstraints not implemented")
}
func (UnimplementedDebugServer) GetSemaphoreLevel(context.Context, *SemaphoreLevelRequest) (*SemaphoreLevelResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSemaphoreLevel not implemented")
}
func (UnimplementedDebugServer) GetAppSemaphoreLevel(context.Context, *AppSemaphoreLevelRequest) (*SemaphoreLevelResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAppSemaphoreLevel not implemented")
}
func (UnimplementedDebugServer) GetFunctionSemaphoreLevel(context.Context, *FunctionSemaphoreLevelRequest) (*SemaphoreLevelResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetFunctionSemaphoreLevel not implemented")
}
func (UnimplementedDebugServer) SetSemaphoreLevel(context.Context, *SetSemaphoreLevelRequest) (*SetSemaphoreLevelResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetSemaphoreLevel not implemented")
}
func (UnimplementedDebugServer) SetAppSemaphoreLevel(context.Context, *SetAppSemaphoreLevelRequest) (*SetSemaphoreLevelResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetAppSemaphoreLevel not implemented")
}
func (UnimplementedDebugServer) SetFunctionSemaphoreLevel(context.Context, *SetFunctionSemaphoreLevelRequest) (*SetSemaphoreLevelResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetFunctionSemaphoreLevel not implemented")
}
...
func (UnimplementedDebugServer) DeleteDebounceByID(context.Context, *DeleteDebounceByIDRequest) (*DeleteDebounceByIDResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteDebounceByID not implemented")
}
func (UnimplementedDebugServer) GetShadowPartition(context.Context, *ShadowPartitionRequest) (*ShadowPartitionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetShadowPartition not implemented")
}
func (UnimplementedDebugServer) GetBacklogs(context.Context, *BacklogsRequest) (*BacklogsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBacklogs not implemented")
}
func (UnimplementedDebugServer) GetBacklogSize(context.Context, *BacklogSizeRequest) (*BacklogSizeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBacklogSize not implemented")
}
...
func _Debug_GetSemaphoreLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SemaphoreLevelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DebugServer).GetSemaphoreLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Debug_GetSemaphoreLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DebugServer).GetSemaphoreLevel(ctx, req.(*SemaphoreLevelRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Debug_GetAppSemaphoreLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AppSemaphoreLevelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DebugServer).GetAppSemaphoreLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Debug_GetAppSemaphoreLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DebugServer).GetAppSemaphoreLevel(ctx, req.(*AppSemaphoreLevelRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Debug_GetFunctionSemaphoreLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FunctionSemaphoreLevelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DebugServer).GetFunctionSemaphoreLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Debug_GetFunctionSemaphoreLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DebugServer).GetFunctionSemaphoreLevel(ctx, req.(*FunctionSemaphoreLevelRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Debug_SetSemaphoreLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetSemaphoreLevelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DebugServer).SetSemaphoreLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Debug_SetSemaphoreLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DebugServer).SetSemaphoreLevel(ctx, req.(*SetSemaphoreLevelRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Debug_SetAppSemaphoreLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetAppSemaphoreLevelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DebugServer).SetAppSemaphoreLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Debug_SetAppSemaphoreLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DebugServer).SetAppSemaphoreLevel(ctx, req.(*SetAppSemaphoreLevelRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Debug_SetFunctionSemaphoreLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetFunctionSemaphoreLevelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DebugServer).SetFunctionSemaphoreLevel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Debug_SetFunctionSemaphoreLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DebugServer).SetFunctionSemaphoreLevel(ctx, req.(*SetFunctionSemaphoreLevelRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Debug_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSemaphoreLevel",
			Handler:    _Debug_GetSemaphoreLevel_Handler,
		},
		{
			MethodName: "GetAppSemaphoreLevel",
			Handler:    _Debug_GetAppSemaphoreLevel_Handler,
		},
		{
			MethodName: "GetFunctionSemaphoreLevel",
			Handler:    _Debug_GetFunctionSemaphoreLevel_Handler,
		},
		{
			MethodName: "SetSemaphoreLevel",
			Handler:    _Debug_SetSemaphoreLevel_Handler,
		},
		{
			MethodName: "SetAppSemaphoreLevel",
			Handler:    _Debug_SetAppSemaphoreLevel_Handler,
		},
		{
			MethodName: "SetFunctionSemaphoreLevel",
			Handler:    _Debug_SetFunctionSemaphoreLevel_Handler,
		},
		{
