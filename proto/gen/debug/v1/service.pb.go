...
const file_debug_v1_service_proto_rawDesc = "" +
	"\n" +
	"\x16debug/v1/service.proto\x12\bdebug.v1\x1a\x14debug/v1/queue.proto\x1a\x14debug/v1/pause.proto\x1a\x1cdebug/v1/constraintapi.proto\x1a\x14debug/v1/batch.proto\x1a\x18debug/v1/singleton.proto\x1a\x17debug/v1/debounce.proto\x1a\x1econstraintapi/v1/service.proto2\xe2\n" +
	"\n" +
	"\x05Debug\x12I\n" +
	...
	"\x12DeleteDebounceByID\x12#.debug.v1.DeleteDebounceByIDRequest\x1a$.debug.v1.DeleteDebounceByIDResponse\"\x00B5Z3github.com/inngest/inngest/proto/gen/debug/v1;debugb\x06proto3"
...
var file_debug_v1_service_proto_goTypes = []any{
	...
	(*PartitionResponse)(nil),           // 16: debug.v1.PartitionResponse
	(*PartitionStatusResponse)(nil),     // 17: debug.v1.PartitionStatusResponse
	(*QueueItemResponse)(nil),           // 18: debug.v1.QueueItemResponse
	(*PauseResponse)(nil),               // 19: debug.v1.PauseResponse
	(*IndexResponse)(nil),               // 20: debug.v1.IndexResponse
	(*BlockPeekResponse)(nil),           // 21: debug.v1.BlockPeekResponse
	(*BlockDeletedResponse)(nil),        // 22: debug.v1.BlockDeletedResponse
	(*CheckConstraintsResponse)(nil),    // 23: debug.v1.CheckConstraintsResponse
	(*BatchInfoResponse)(nil),           // 24: debug.v1.BatchInfoResponse
	(*DeleteBatchResponse)(nil),         // 25: debug.v1.DeleteBatchResponse
	(*RunBatchResponse)(nil),            // 26: debug.v1.RunBatchResponse
	(*SingletonInfoResponse)(nil),       // 27: debug.v1.SingletonInfoResponse
	(*DeleteSingletonLockResponse)(nil), // 28: debug.v1.DeleteSingletonLockResponse
	(*DebounceInfoResponse)(nil),        // 29: debug.v1.DebounceInfoResponse
	(*DeleteDebounceResponse)(nil),      // 30: debug.v1.DeleteDebounceResponse
	(*RunDebounceResponse)(nil),         // 31: debug.v1.RunDebounceResponse
	(*DeleteDebounceByIDResponse)(nil),  // 32: debug.v1.DeleteDebounceByIDResponse
}
var file_debug_v1_service_proto_depIdxs = []int32{
	...
	15, // 16: debug.v1.Debug.DeleteDebounceByID:input_type -> debug.v1.DeleteDebounceByIDRequest
	16, // 17: debug.v1.Debug.GetPartition:output_type -> debug.v1.PartitionResponse
	17, // 18: debug.v1.Debug.GetPartitionStatus:output_type -> debug.v1.PartitionStatusResponse
	18, // 19: debug.v1.Debug.GetQueueItem:output_type -> debug.v1.QueueItemResponse
	19, // 20: debug.v1.Debug.GetPause:output_type -> debug.v1.PauseResponse
	20, // 21: debug.v1.Debug.GetIndex:output_type -> debug.v1.IndexResponse
	21, // 22: debug.v1.Debug.BlockPeek:output_type -> debug.v1.BlockPeekResponse
	22, // 23: debug.v1.Debug.BlockDeleted:output_type -> debug.v1.BlockDeletedResponse
	23, // 24: debug.v1.Debug.CheckConstraints:output_type -> debug.v1.CheckConstraintsResponse
	24, // 25: debug.v1.Debug.GetBatchInfo:output_type -> debug.v1.BatchInfoResponse
	25, // 26: debug.v1.Debug.DeleteBatch:output_type -> debug.v1.DeleteBatchResponse
	26, // 27: debug.v1.Debug.RunBatch:output_type -> debug.v1.RunBatchResponse
	27, // 28: debug.v1.Debug.GetSingletonInfo:output_type -> debug.v1.SingletonInfoResponse
	28, // 29: debug.v1.Debug.DeleteSingletonLock:output_type -> debug.v1.DeleteSingletonLockResponse
	29, // 30: debug.v1.Debug.GetDebounceInfo:output_type -> debug.v1.DebounceInfoResponse
	30, // 31: debug.v1.Debug.DeleteDebounce:output_type -> debug.v1.DeleteDebounceResponse
	31, // 32: debug.v1.Debug.RunDebounce:output_type -> debug.v1.RunDebounceResponse
	32, // 33: debug.v1.Debug.DeleteDebounceByID:output_type -> debug.v1.DeleteDebounceByIDResponse
