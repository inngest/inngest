...
const (
	...
	// V2SyncNewAppProcedure is the fully-qualified name of the V2's SyncNewApp RPC.
	V2SyncNewAppProcedure = "/api.v2.V2/SyncNewApp"
)
...
type V2Client interface {
	...
	SyncNewApp(context.Context, *connect.Request[v2.SyncNewAppRequest]) (*connect.Response[v2.SyncNewAppResponse], error)
}
...
func NewV2Client(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) V2Client {
	...
	return &v2Client{
		...
		syncNewApp: connect.NewClient[v2.SyncNewAppRequest, v2.SyncNewAppResponse](
			httpClient,
			baseURL+V2SyncNewAppProcedure,
			connect.WithSchema(v2Methods.ByName("SyncNewApp")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type v2Client struct {
	...
	syncNewApp              *connect.Client[v2.SyncNewAppRequest, v2.SyncNewAppResponse]
}
...
// SyncNewApp calls api.v2.V2.SyncNewApp.
func (c *v2Client) SyncNewApp(ctx context.Context, req *connect.Request[v2.SyncNewAppRequest]) (*connect.Response[v2.SyncNewAppResponse], error) {
	return c.syncNewApp.CallUnary(ctx, req)
}
...
func NewV2Handler(svc V2Handler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	v2SyncNewAppHandler := connect.NewUnaryHandler(
		V2SyncNewAppProcedure,
		svc.SyncNewApp,
		connect.WithSchema(v2Methods.ByName("SyncNewApp")),
		connect.WithHandlerOptions(opts...),
	)
	return "/api.v2.V2/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case V2SyncNewAppProcedure:
			v2SyncNewAppHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedV2Handler) SyncNewApp(context.Context, *connect.Request[v2.SyncNewAppRequest]) (*connect.Response[v2.SyncNewAppResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v2.V2.SyncNewApp is not implemented"))
}
