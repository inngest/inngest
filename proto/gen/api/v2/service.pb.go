...
type ReplayEventResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Data          *ReplayEventData       `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	Metadata      *ResponseMetadata      `protobuf:"bytes,2,opt,name=metadata,proto3" json:"metadata,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReplayEventResponse) GetData() *ReplayEventData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *ReplayEventResponse) GetMetadata() *ResponseMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *ReplayEventData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplayEventData) ProtoMessage() {}

func (x *ReplayEventData) ProtoReflect() protoreflect.Message {
	mi := &file_api_v2_service_proto_msgTypes[36]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplayEventData.ProtoReflect.Descriptor instead.
func (*ReplayEventData) Descriptor() ([]byte, []int) {
...
var file_api_v2_service_proto_msgTypes = make([]protoimpl.MessageInfo, 125)
var file_api_v2_service_proto_goTypes = []any{
	...
	(*ReplayEventRequest)(nil),                    // 45: api.v2.ReplayEventRequest
	(*ReplayEventResponse)(nil),                   // 46: api.v2.ReplayEventResponse
	(*ReplayEventData)(nil),                       // 47: api.v2.ReplayEventData
	(*TraceSpanMetadata)(nil),                     // 48: api.v2.TraceSpanMetadata
	(*TraceSpan)(nil),                             // 49: api.v2.TraceSpan
	(*FunctionTrace)(nil),                         // 50: api.v2.FunctionTrace
	(*GetFunctionTraceRequest)(nil),               // 51: api.v2.GetFunctionTraceRequest
	(*GetFunctionTraceResponse)(nil),              // 52: api.v2.GetFunctionTraceResponse
	(*GetFunctionRequest)(nil),                    // 53: api.v2.GetFunctionRequest
	(*GetFunctionResponse)(nil),                   // 54: api.v2.GetFunctionResponse
	(*App)(nil),                                   // 55: api.v2.App
	(*AppSync)(nil),                               // 56: api.v2.AppSync
	(*GetAppRequest)(nil),                         // 57: api.v2.GetAppRequest
	(*GetAppResponse)(nil),                        // 58: api.v2.GetAppResponse
	(*GetFunctionsRequest)(nil),                   // 59: api.v2.GetFunctionsRequest
	(*GetFunctionsResponse)(nil),                  // 60: api.v2.GetFunctionsResponse
	(*CreateAccountRequest)(nil),                  // 61: api.v2.CreateAccountRequest
	(*CreateAccountResponse)(nil),                 // 62: api.v2.CreateAccountResponse
	(*CreateEnvRequest)(nil),                      // 63: api.v2.CreateEnvRequest
	(*CreateEnvResponse)(nil),                     // 64: api.v2.CreateEnvResponse
	(*Env)(nil),                                   // 65: api.v2.Env
	(*CreateAccountData)(nil),                     // 66: api.v2.CreateAccountData
	(*FetchAccountsRequest)(nil),                  // 67: api.v2.FetchAccountsRequest
	(*FetchAccountsResponse)(nil),                 // 68: api.v2.FetchAccountsResponse
	(*FetchAccountResponse)(nil),                  // 69: api.v2.FetchAccountResponse
	(*Account)(nil),                               // 70: api.v2.Account
	(*Page)(nil),                                  // 71: api.v2.Page
	(*FetchAccountEventKeysRequest)(nil),          // 72: api.v2.FetchAccountEventKeysRequest
	(*FetchAccountEventKeysResponse)(nil),         // 73: api.v2.FetchAccountEventKeysResponse
	(*EventKey)(nil),                              // 74: api.v2.EventKey
	(*FetchAccountEnvsRequest)(nil),               // 75: api.v2.FetchAccountEnvsRequest
	(*FetchAccountEnvsResponse)(nil),              // 76: api.v2.FetchAccountEnvsResponse
	(*FetchAccountSigningKeysRequest)(nil),        // 77: api.v2.FetchAccountSigningKeysRequest
	(*FetchAccountSigningKeysResponse)(nil),       // 78: api.v2.FetchAccountSigningKeysResponse
	(*SigningKey)(nil),                            // 79: api.v2.SigningKey
	(*CreateWebhookRequest)(nil),                  // 80: api.v2.CreateWebhookRequest
	(*CreateWebhookResponse)(nil),                 // 81: api.v2.CreateWebhookResponse
	(*EventFilter)(nil),                           // 82: api.v2.EventFilter
	(*ListWebhooksRequest)(nil),                   // 83: api.v2.ListWebhooksRequest
	(*ListWebhooksResponse)(nil),                  // 84: api.v2.ListWebhooksResponse
	(*Webhook)(nil),                               // 85: api.v2.Webhook
	(*PatchEnvRequest)(nil),                       // 86: api.v2.PatchEnvRequest
	(*PatchEnvsResponse)(nil),                     // 87: api.v2.PatchEnvsResponse
	(*InvokeFunctionRequest)(nil),                 // 88: api.v2.InvokeFunctionRequest
	(*InvokeFunctionResponse)(nil),                // 89: api.v2.InvokeFunctionResponse
	(*InvokeFunctionData)(nil),                    // 90: api.v2.InvokeFunctionData
	(*CreateScoreRequest)(nil),                    // 91: api.v2.CreateScoreRequest
	(*CreateScoreInput)(nil),                      // 92: api.v2.CreateScoreInput
	(*ScoreExperiment)(nil),                       // 93: api.v2.ScoreExperiment
	(*CreateScoreResponse)(nil),                   // 94: api.v2.CreateScoreResponse
	(*Score)(nil),                                 // 95: api.v2.Score
	(*SyncAppRequest)(nil),                        // 96: api.v2.SyncAppRequest
	(*SyncAppResponse)(nil),                       // 97: api.v2.SyncAppResponse
	(*SyncAppData)(nil),                           // 98: api.v2.SyncAppData
	(*SyncAppError)(nil),                          // 99: api.v2.SyncAppError
	(*QueryInsightsRequest)(nil),                  // 100: api.v2.QueryInsightsRequest
	(*QueryInsightsResponse)(nil),                 // 101: api.v2.QueryInsightsResponse
	(*QueryInsightsData)(nil),                     // 102: api.v2.QueryInsightsData
	(*InsightsOutputColumn)(nil),                  // 103: api.v2.InsightsOutputColumn
	(*InsightsRow)(nil),                           // 104: api.v2.InsightsRow
	(*InsightsDiagnostic)(nil),                    // 105: api.v2.InsightsDiagnostic
	(*InsightsDiagnosticPosition)(nil),            // 106: api.v2.InsightsDiagnosticPosition
	(*ListInsightsTablesRequest)(nil),             // 107: api.v2.ListInsightsTablesRequest
	(*ListInsightsTablesResponse)(nil),            // 108: api.v2.ListInsightsTablesResponse
	(*InsightsTable)(nil),                         // 109: api.v2.InsightsTable
	(*InsightsTableColumn)(nil),                   // 110: api.v2.InsightsTableColumn
	(*QueryInsightsPromptRequest)(nil),            // 111: api.v2.QueryInsightsPromptRequest
	(*QueryInsightsPromptResponse)(nil),           // 112: api.v2.QueryInsightsPromptResponse
	(*QueryInsightsPromptData)(nil),               // 113: api.v2.QueryInsightsPromptData
	(*ListInsightsEventSchemasRequest)(nil),       // 114: api.v2.ListInsightsEventSchemasRequest
	(*ListInsightsEventSchemasResponse)(nil),      // 115: api.v2.ListInsightsEventSchemasResponse
	(*InsightsEventSchema)(nil),                   // 116: api.v2.InsightsEventSchema
	(*ListExperimentsRequest)(nil),                // 117: api.v2.ListExperimentsRequest
	(*ListExperimentsResponse)(nil),               // 118: api.v2.ListExperimentsResponse
	(*Experiment)(nil),                            // 119: api.v2.Experiment
	(*GetExperimentRequest)(nil),                  // 120: api.v2.GetExperimentRequest
	(*GetExperimentResponse)(nil),                 // 121: api.v2.GetExperimentResponse
	(*ExperimentDetail)(nil),                      // 122: api.v2.ExperimentDetail
	(*ExperimentVariantMetrics)(nil),              // 123: api.v2.ExperimentVariantMetrics
	(*ExperimentVariantMetric)(nil),               // 124: api.v2.ExperimentVariantMetric
	(*ExperimentVariantWeight)(nil),               // 125: api.v2.ExperimentVariantWeight
	(*ListSessionKeysRequest)(nil),                // 126: api.v2.ListSessionKeysRequest
	(*ListSessionKeysResponse)(nil),               // 127: api.v2.ListSessionKeysResponse
	(*SessionKey)(nil),                            // 128: api.v2.SessionKey
	(*ListSessionsRequest)(nil),                   // 129: api.v2.ListSessionsRequest
	(*ListSessionsResponse)(nil),                  // 130: api.v2.ListSessionsResponse
	(*SessionGroup)(nil),                          // 131: api.v2.SessionGroup
	(*ListSessionRunsRequest)(nil),                // 132: api.v2.ListSessionRunsRequest
	(*ListSessionRunsResponse)(nil),               // 133: api.v2.ListSessionRunsResponse
	(*SessionRun)(nil),                            // 134: api.v2.SessionRun
	nil,                                           // 135: api.v2.TraceSpanMetadata.ValuesEntry
...
var file_api_v2_service_proto_depIdxs = []int32{
	...
	136, // 3: api.v2.ResponseMetadata.fetched_at:type_name -> google.protobuf.Timestamp
	136, // 4: api.v2.ResponseMetadata.cached_until:type_name -> google.protobuf.Timestamp
	18,  // 5: api.v2.ResponseMetadata.time_range:type_name -> api.v2.TimeRange
	136, // 6: api.v2.TimeRange.from:type_name -> google.protobuf.Timestamp
	136, // 7: api.v2.TimeRange.until:type_name -> google.protobuf.Timestamp
	...
	136, // 28: api.v2.FunctionRun.queued_at:type_name -> google.protobuf.Timestamp
	136, // 29: api.v2.FunctionRun.started_at:type_name -> google.protobuf.Timestamp
	136, // 30: api.v2.FunctionRun.ended_at:type_name -> google.protobuf.Timestamp
	35,  // 31: api.v2.FunctionRun.trigger:type_name -> api.v2.RunTrigger
	137, // 32: api.v2.FunctionRun.output:type_name -> google.protobuf.Struct
	...
	71,  // 37: api.v2.GetEventRunsResponse.page:type_name -> api.v2.Page
	42,  // 38: api.v2.RerunRequest.from_step:type_name -> api.v2.RerunFromStep
	138, // 39: api.v2.RerunFromStep.input:type_name -> google.protobuf.ListValue
	...
	47,  // 42: api.v2.ReplayEventResponse.data:type_name -> api.v2.ReplayEventData
	17,  // 43: api.v2.ReplayEventResponse.metadata:type_name -> api.v2.ResponseMetadata
	135, // 44: api.v2.TraceSpanMetadata.values:type_name -> api.v2.TraceSpanMetadata.ValuesEntry
	136, // 45: api.v2.TraceSpanMetadata.updated_at:type_name -> google.protobuf.Timestamp
	1,   // 46: api.v2.TraceSpan.status:type_name -> api.v2.TraceSpanStatus
	2,   // 47: api.v2.TraceSpan.step_op:type_name -> api.v2.TraceStepOp
	136, // 48: api.v2.TraceSpan.queued_at:type_name -> google.protobuf.Timestamp
	136, // 49: api.v2.TraceSpan.started_at:type_name -> google.protobuf.Timestamp
	136, // 50: api.v2.TraceSpan.ended_at:type_name -> google.protobuf.Timestamp
	137, // 51: api.v2.TraceSpan.input:type_name -> google.protobuf.Struct
	137, // 52: api.v2.TraceSpan.output:type_name -> google.protobuf.Struct
	48,  // 53: api.v2.TraceSpan.metadata:type_name -> api.v2.TraceSpanMetadata
	49,  // 54: api.v2.TraceSpan.children:type_name -> api.v2.TraceSpan
	49,  // 55: api.v2.FunctionTrace.root_span:type_name -> api.v2.TraceSpan
	50,  // 56: api.v2.GetFunctionTraceResponse.data:type_name -> api.v2.FunctionTrace
	17,  // 57: api.v2.GetFunctionTraceResponse.metadata:type_name -> api.v2.ResponseMetadata
	34,  // 58: api.v2.GetFunctionResponse.data:type_name -> api.v2.Function
	17,  // 59: api.v2.GetFunctionResponse.metadata:type_name -> api.v2.ResponseMetadata
	6,   // 60: api.v2.App.method:type_name -> api.v2.AppMethod
	136, // 61: api.v2.App.created_at:type_name -> google.protobuf.Timestamp
	136, // 62: api.v2.App.archived_at:type_name -> google.protobuf.Timestamp
	56,  // 63: api.v2.App.latest_sync:type_name -> api.v2.AppSync
	136, // 64: api.v2.AppSync.synced_at:type_name -> google.protobuf.Timestamp
	55,  // 65: api.v2.GetAppResponse.data:type_name -> api.v2.App
	17,  // 66: api.v2.GetAppResponse.metadata:type_name -> api.v2.ResponseMetadata
	34,  // 67: api.v2.GetFunctionsResponse.data:type_name -> api.v2.Function
	17,  // 68: api.v2.GetFunctionsResponse.metadata:type_name -> api.v2.ResponseMetadata
	71,  // 69: api.v2.GetFunctionsResponse.page:type_name -> api.v2.Page
	66,  // 70: api.v2.CreateAccountResponse.data:type_name -> api.v2.CreateAccountData
	17,  // 71: api.v2.CreateAccountResponse.metadata:type_name -> api.v2.ResponseMetadata
	65,  // 72: api.v2.CreateEnvResponse.data:type_name -> api.v2.Env
	17,  // 73: api.v2.CreateEnvResponse.metadata:type_name -> api.v2.ResponseMetadata
	7,   // 74: api.v2.Env.type:type_name -> api.v2.EnvType
	136, // 75: api.v2.Env.createdAt:type_name -> google.protobuf.Timestamp
	136, // 76: api.v2.CreateAccountData.createdAt:type_name -> google.protobuf.Timestamp
	136, // 77: api.v2.CreateAccountData.updatedAt:type_name -> google.protobuf.Timestamp
	70,  // 78: api.v2.FetchAccountsResponse.data:type_name -> api.v2.Account
	17,  // 79: api.v2.FetchAccountsResponse.metadata:type_name -> api.v2.ResponseMetadata
	71,  // 80: api.v2.FetchAccountsResponse.page:type_name -> api.v2.Page
	70,  // 81: api.v2.FetchAccountResponse.data:type_name -> api.v2.Account
	17,  // 82: api.v2.FetchAccountResponse.metadata:type_name -> api.v2.ResponseMetadata
	136, // 83: api.v2.Account.createdAt:type_name -> google.protobuf.Timestamp
	136, // 84: api.v2.Account.updatedAt:type_name -> google.protobuf.Timestamp
	74,  // 85: api.v2.FetchAccountEventKeysResponse.data:type_name -> api.v2.EventKey
	17,  // 86: api.v2.FetchAccountEventKeysResponse.metadata:type_name -> api.v2.ResponseMetadata
	71,  // 87: api.v2.FetchAccountEventKeysResponse.page:type_name -> api.v2.Page
	136, // 88: api.v2.EventKey.createdAt:type_name -> google.protobuf.Timestamp
	65,  // 89: api.v2.FetchAccountEnvsResponse.data:type_name -> api.v2.Env
	17,  // 90: api.v2.FetchAccountEnvsResponse.metadata:type_name -> api.v2.ResponseMetadata
	71,  // 91: api.v2.FetchAccountEnvsResponse.page:type_name -> api.v2.Page
	79,  // 92: api.v2.FetchAccountSigningKeysResponse.data:type_name -> api.v2.SigningKey
	17,  // 93: api.v2.FetchAccountSigningKeysResponse.metadata:type_name -> api.v2.ResponseMetadata
	71,  // 94: api.v2.FetchAccountSigningKeysResponse.page:type_name -> api.v2.Page
	136, // 95: api.v2.SigningKey.createdAt:type_name -> google.protobuf.Timestamp
	82,  // 96: api.v2.CreateWebhookRequest.event_filter:type_name -> api.v2.EventFilter
	85,  // 97: api.v2.CreateWebhookResponse.data:type_name -> api.v2.Webhook
	17,  // 98: api.v2.CreateWebhookResponse.metadata:type_name -> api.v2.ResponseMetadata
	8,   // 99: api.v2.EventFilter.filter:type_name -> api.v2.FilterType
	85,  // 100: api.v2.ListWebhooksResponse.data:type_name -> api.v2.Webhook
	17,  // 101: api.v2.ListWebhooksResponse.metadata:type_name -> api.v2.ResponseMetadata
	71,  // 102: api.v2.ListWebhooksResponse.page:type_name -> api.v2.Page
	82,  // 103: api.v2.Webhook.event_filter:type_name -> api.v2.EventFilter
	136, // 104: api.v2.Webhook.createdAt:type_name -> google.protobuf.Timestamp
	136, // 105: api.v2.Webhook.updatedAt:type_name -> google.protobuf.Timestamp
	65,  // 106: api.v2.PatchEnvsResponse.data:type_name -> api.v2.Env
	17,  // 107: api.v2.PatchEnvsResponse.metadata:type_name -> api.v2.ResponseMetadata
	137, // 108: api.v2.InvokeFunctionRequest.data:type_name -> google.protobuf.Struct
	90,  // 109: api.v2.InvokeFunctionResponse.data:type_name -> api.v2.InvokeFunctionData
	17,  // 110: api.v2.InvokeFunctionResponse.metadata:type_name -> api.v2.ResponseMetadata
	136, // 111: api.v2.InvokeFunctionData.queued_at:type_name -> google.protobuf.Timestamp
	136, // 112: api.v2.InvokeFunctionData.started_at:type_name -> google.protobuf.Timestamp
	136, // 113: api.v2.InvokeFunctionData.completed_at:type_name -> google.protobuf.Timestamp
	92,  // 114: api.v2.CreateScoreRequest.scores:type_name -> api.v2.CreateScoreInput
	139, // 115: api.v2.CreateScoreInput.value:type_name -> google.protobuf.Value
	93,  // 116: api.v2.CreateScoreInput.experiment:type_name -> api.v2.ScoreExperiment
	95,  // 117: api.v2.CreateScoreResponse.data:type_name -> api.v2.Score
	17,  // 118: api.v2.CreateScoreResponse.metadata:type_name -> api.v2.ResponseMetadata
	139, // 119: api.v2.Score.value:type_name -> google.protobuf.Value
	93,  // 120: api.v2.Score.experiment:type_name -> api.v2.ScoreExperiment
	98,  // 121: api.v2.SyncAppResponse.data:type_name -> api.v2.SyncAppData
	17,  // 122: api.v2.SyncAppResponse.metadata:type_name -> api.v2.ResponseMetadata
	99,  // 123: api.v2.SyncAppData.error:type_name -> api.v2.SyncAppError
	102, // 124: api.v2.QueryInsightsResponse.data:type_name -> api.v2.QueryInsightsData
	17,  // 125: api.v2.QueryInsightsResponse.metadata:type_name -> api.v2.ResponseMetadata
	103, // 126: api.v2.QueryInsightsData.columns:type_name -> api.v2.InsightsOutputColumn
	104, // 127: api.v2.QueryInsightsData.rows:type_name -> api.v2.InsightsRow
	105, // 128: api.v2.QueryInsightsData.diagnostics:type_name -> api.v2.InsightsDiagnostic
	9,   // 129: api.v2.InsightsOutputColumn.type:type_name -> api.v2.InsightsOutputColumnType
	139, // 130: api.v2.InsightsRow.values:type_name -> google.protobuf.Value
	10,  // 131: api.v2.InsightsDiagnostic.severity:type_name -> api.v2.InsightsDiagnosticSeverity
	106, // 132: api.v2.InsightsDiagnostic.position:type_name -> api.v2.InsightsDiagnosticPosition
	109, // 133: api.v2.ListInsightsTablesResponse.data:type_name -> api.v2.InsightsTable
	17,  // 134: api.v2.ListInsightsTablesResponse.metadata:type_name -> api.v2.ResponseMetadata
	110, // 135: api.v2.InsightsTable.columns:type_name -> api.v2.InsightsTableColumn
	113, // 136: api.v2.QueryInsightsPromptResponse.data:type_name -> api.v2.QueryInsightsPromptData
	17,  // 137: api.v2.QueryInsightsPromptResponse.metadata:type_name -> api.v2.ResponseMetadata
	116, // 138: api.v2.ListInsightsEventSchemasResponse.data:type_name -> api.v2.InsightsEventSchema
	17,  // 139: api.v2.ListInsightsEventSchemasResponse.metadata:type_name -> api.v2.ResponseMetadata
	71,  // 140: api.v2.ListInsightsEventSchemasResponse.page:type_name -> api.v2.Page
	137, // 141: api.v2.InsightsEventSchema.schema:type_name -> google.protobuf.Struct
	136, // 142: api.v2.ListExperimentsRequest.from:type_name -> google.protobuf.Timestamp
	136, // 143: api.v2.ListExperimentsRequest.until:type_name -> google.protobuf.Timestamp
	119, // 144: api.v2.ListExperimentsResponse.data:type_name -> api.v2.Experiment
	17,  // 145: api.v2.ListExperimentsResponse.metadata:type_name -> api.v2.ResponseMetadata
	71,  // 146: api.v2.ListExperimentsResponse.page:type_name -> api.v2.Page
	19,  // 147: api.v2.Experiment.function:type_name -> api.v2.FunctionRef
	136, // 148: api.v2.Experiment.first_seen:type_name -> google.protobuf.Timestamp
	136, // 149: api.v2.Experiment.last_seen:type_name -> google.protobuf.Timestamp
	136, // 150: api.v2.GetExperimentRequest.from:type_name -> google.protobuf.Timestamp
	136, // 151: api.v2.GetExperimentRequest.until:type_name -> google.protobuf.Timestamp
	122, // 152: api.v2.GetExperimentResponse.data:type_name -> api.v2.ExperimentDetail
	17,  // 153: api.v2.GetExperimentResponse.metadata:type_name -> api.v2.ResponseMetadata
	123, // 154: api.v2.ExperimentDetail.variants:type_name -> api.v2.ExperimentVariantMetrics
	125, // 155: api.v2.ExperimentDetail.variant_weights:type_name -> api.v2.ExperimentVariantWeight
	136, // 156: api.v2.ExperimentDetail.first_seen:type_name -> google.protobuf.Timestamp
	136, // 157: api.v2.ExperimentDetail.last_seen:type_name -> google.protobuf.Timestamp
	124, // 158: api.v2.ExperimentVariantMetrics.metrics:type_name -> api.v2.ExperimentVariantMetric
	128, // 159: api.v2.ListSessionKeysResponse.data:type_name -> api.v2.SessionKey
	17,  // 160: api.v2.ListSessionKeysResponse.metadata:type_name -> api.v2.ResponseMetadata
	71,  // 161: api.v2.ListSessionKeysResponse.page:type_name -> api.v2.Page
	136, // 162: api.v2.SessionKey.created_at:type_name -> google.protobuf.Timestamp
	136, // 163: api.v2.ListSessionsRequest.from:type_name -> google.protobuf.Timestamp
	136, // 164: api.v2.ListSessionsRequest.until:type_name -> google.protobuf.Timestamp
	131, // 165: api.v2.ListSessionsResponse.data:type_name -> api.v2.SessionGroup
	17,  // 166: api.v2.ListSessionsResponse.metadata:type_name -> api.v2.ResponseMetadata
	71,  // 167: api.v2.ListSessionsResponse.page:type_name -> api.v2.Page
	136, // 168: api.v2.SessionGroup.last_active_at:type_name -> google.protobuf.Timestamp
	19,  // 169: api.v2.SessionGroup.functions:type_name -> api.v2.FunctionRef
	136, // 170: api.v2.ListSessionRunsRequest.from:type_name -> google.protobuf.Timestamp
	136, // 171: api.v2.ListSessionRunsRequest.until:type_name -> google.protobuf.Timestamp
	134, // 172: api.v2.ListSessionRunsResponse.data:type_name -> api.v2.SessionRun
	17,  // 173: api.v2.ListSessionRunsResponse.metadata:type_name -> api.v2.ResponseMetadata
	71,  // 174: api.v2.ListSessionRunsResponse.page:type_name -> api.v2.Page
	19,  // 175: api.v2.SessionRun.function:type_name -> api.v2.FunctionRef
	0,   // 176: api.v2.SessionRun.status:type_name -> api.v2.FunctionRunStatus
	136, // 177: api.v2.SessionRun.queued_at:type_name -> google.protobuf.Timestamp
	136, // 178: api.v2.SessionRun.started_at:type_name -> google.protobuf.Timestamp
	136, // 179: api.v2.SessionRun.ended_at:type_name -> google.protobuf.Timestamp
	11,  // 180: api.v2.V2.Health:input_type -> api.v2.HealthRequest
	11,  // 181: api.v2.V2._SchemaOnly:input_type -> api.v2.HealthRequest
	61,  // 182: api.v2.V2.CreatePartnerAccount:input_type -> api.v2.CreateAccountRequest
	63,  // 183: api.v2.V2.CreateEnv:input_type -> api.v2.CreateEnvRequest
	67,  // 184: api.v2.V2.FetchPartnerAccounts:input_type -> api.v2.FetchAccountsRequest
	12,  // 185: api.v2.V2.FetchAccount:input_type -> api.v2.FetchAccountRequest
	75,  // 186: api.v2.V2.FetchAccountEnvs:input_type -> api.v2.FetchAccountEnvsRequest
	72,  // 187: api.v2.V2.FetchAccountEventKeys:input_type -> api.v2.FetchAccountEventKeysRequest
	77,  // 188: api.v2.V2.FetchAccountSigningKeys:input_type -> api.v2.FetchAccountSigningKeysRequest
	80,  // 189: api.v2.V2.CreateWebhook:input_type -> api.v2.CreateWebhookRequest
	83,  // 190: api.v2.V2.ListWebhooks:input_type -> api.v2.ListWebhooksRequest
	86,  // 191: api.v2.V2.PatchEnv:input_type -> api.v2.PatchEnvRequest
	37,  // 192: api.v2.V2.GetFunctionRun:input_type -> api.v2.GetFunctionRunRequest
	39,  // 193: api.v2.V2.GetEventRuns:input_type -> api.v2.GetEventRunsRequest
	41,  // 194: api.v2.V2.Rerun:input_type -> api.v2.RerunRequest
	45,  // 195: api.v2.V2.ReplayEvent:input_type -> api.v2.ReplayEventRequest
	57,  // 196: api.v2.V2.GetApp:input_type -> api.v2.GetAppRequest
	91,  // 197: api.v2.V2.CreateScore:input_type -> api.v2.CreateScoreRequest
	96,  // 198: api.v2.V2.SyncApp:input_type -> api.v2.SyncAppRequest
	51,  // 199: api.v2.V2.GetFunctionTrace:input_type -> api.v2.GetFunctionTraceRequest
	53,  // 200: api.v2.V2.GetFunction:input_type -> api.v2.GetFunctionRequest
	59,  // 201: api.v2.V2.GetFunctions:input_type -> api.v2.GetFunctionsRequest
	88,  // 202: api.v2.V2.InvokeFunction:input_type -> api.v2.InvokeFunctionRequest
	107, // 203: api.v2.V2.ListInsightsTables:input_type -> api.v2.ListInsightsTablesRequest
	114, // 204: api.v2.V2.ListInsightsEventSchemas:input_type -> api.v2.ListInsightsEventSchemasRequest
	111, // 205: api.v2.V2.QueryInsightsPrompt:input_type -> api.v2.QueryInsightsPromptRequest
	100, // 206: api.v2.V2.QueryInsights:input_type -> api.v2.QueryInsightsRequest
	117, // 207: api.v2.V2.ListExperiments:input_type -> api.v2.ListExperimentsRequest
	120, // 208: api.v2.V2.GetExperiment:input_type -> api.v2.GetExperimentRequest
	126, // 209: api.v2.V2.ListSessionKeys:input_type -> api.v2.ListSessionKeysRequest
	129, // 210: api.v2.V2.ListSessions:input_type -> api.v2.ListSessionsRequest
	132, // 211: api.v2.V2.ListSessionRuns:input_type -> api.v2.ListSessionRunsRequest
	13,  // 212: api.v2.V2.Health:output_type -> api.v2.HealthResponse
	16,  // 213: api.v2.V2._SchemaOnly:output_type -> api.v2.ErrorResponse
	62,  // 214: api.v2.V2.CreatePartnerAccount:output_type -> api.v2.CreateAccountResponse
	64,  // 215: api.v2.V2.CreateEnv:output_type -> api.v2.CreateEnvResponse
	68,  // 216: api.v2.V2.FetchPartnerAccounts:output_type -> api.v2.FetchAccountsResponse
	69,  // 217: api.v2.V2.FetchAccount:output_type -> api.v2.FetchAccountResponse
	76,  // 218: api.v2.V2.FetchAccountEnvs:output_type -> api.v2.FetchAccountEnvsResponse
	73,  // 219: api.v2.V2.FetchAccountEventKeys:output_type -> api.v2.FetchAccountEventKeysResponse
	78,  // 220: api.v2.V2.FetchAccountSigningKeys:output_type -> api.v2.FetchAccountSigningKeysResponse
	81,  // 221: api.v2.V2.CreateWebhook:output_type -> api.v2.CreateWebhookResponse
	84,  // 222: api.v2.V2.ListWebhooks:output_type -> api.v2.ListWebhooksResponse
	87,  // 223: api.v2.V2.PatchEnv:output_type -> api.v2.PatchEnvsResponse
	38,  // 224: api.v2.V2.GetFunctionRun:output_type -> api.v2.GetFunctionRunResponse
	40,  // 225: api.v2.V2.GetEventRuns:output_type -> api.v2.GetEventRunsResponse
	43,  // 226: api.v2.V2.Rerun:output_type -> api.v2.RerunResponse
	46,  // 227: api.v2.V2.ReplayEvent:output_type -> api.v2.ReplayEventResponse
	58,  // 228: api.v2.V2.GetApp:output_type -> api.v2.GetAppResponse
	94,  // 229: api.v2.V2.CreateScore:output_type -> api.v2.CreateScoreResponse
	97,  // 230: api.v2.V2.SyncApp:output_type -> api.v2.SyncAppResponse
	52,  // 231: api.v2.V2.GetFunctionTrace:output_type -> api.v2.GetFunctionTraceResponse
	54,  // 232: api.v2.V2.GetFunction:output_type -> api.v2.GetFunctionResponse
	60,  // 233: api.v2.V2.GetFunctions:output_type -> api.v2.GetFunctionsResponse
	89,  // 234: api.v2.V2.InvokeFunction:output_type -> api.v2.InvokeFunctionResponse
	108, // 235: api.v2.V2.ListInsightsTables:output_type -> api.v2.ListInsightsTablesResponse
	115, // 236: api.v2.V2.ListInsightsEventSchemas:output_type -> api.v2.ListInsightsEventSchemasResponse
	112, // 237: api.v2.V2.QueryInsightsPrompt:output_type -> api.v2.QueryInsightsPromptResponse
	101, // 238: api.v2.V2.QueryInsights:output_type -> api.v2.QueryInsightsResponse
	118, // 239: api.v2.V2.ListExperiments:output_type -> api.v2.ListExperimentsResponse
	121, // 240: api.v2.V2.GetExperiment:output_type -> api.v2.GetExperimentResponse
	127, // 241: api.v2.V2.ListSessionKeys:output_type -> api.v2.ListSessionKeysResponse
	130, // 242: api.v2.V2.ListSessions:output_type -> api.v2.ListSessionsResponse
	133, // 243: api.v2.V2.ListSessionRuns:output_type -> api.v2.ListSessionRunsResponse
...
func file_api_v2_service_proto_init() {
	...
	file_api_v2_service_proto_msgTypes[64].OneofWrappers = []any{}
	file_api_v2_service_proto_msgTypes[66].OneofWrappers = []any{}
	file_api_v2_service_proto_msgTypes[69].OneofWrappers = []any{}
	...
	file_api_v2_service_proto_msgTypes[77].OneofWrappers = []any{}
	...
	file_api_v2_service_proto_msgTypes[87].OneofWrappers = []any{}
	...
	file_api_v2_service_proto_msgTypes[109].OneofWrappers = []any{}
