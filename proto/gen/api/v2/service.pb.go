...
const file_api_v2_service_proto_rawDesc = "" +
	"\n" +
	"\x14api/v2/service.proto\x12\x06api.v2\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a(third_party/google/api/annotations.proto\x1a+third_party/google/api/field_behavior.proto\x1a\x14api/v2/options.proto\x1a:third_party/protoc-gen-openapiv2/options/annotations.proto\"\x0f\n" +
	"\rHealthRequest\"\x15\n" +
	...
	"\x0e\n" +
	"\n" +
	"BearerAuth\x12\x00\x82\xd3\xe4\x93\x02.\x12,/sessions/{session_key}/{session_id=**}/runsB\xf8\x05\x92A\xc1\x05\x12\x9b\x01\n" +
...
var file_api_v2_service_proto_depIdxs = []int32{
	...
	93,  // 217: api.v2.V2.CreateScore:input_type -> api.v2.CreateScoreRequest
	98,  // 218: api.v2.V2.SyncApp:input_type -> api.v2.SyncAppRequest
	48,  // 219: api.v2.V2.GetFunctionTrace:input_type -> api.v2.GetFunctionTraceRequest
	50,  // 220: api.v2.V2.GetFunction:input_type -> api.v2.GetFunctionRequest
	58,  // 221: api.v2.V2.GetFunctions:input_type -> api.v2.GetFunctionsRequest
	87,  // 222: api.v2.V2.SendEvent:input_type -> api.v2.SendEventRequest
	90,  // 223: api.v2.V2.InvokeFunction:input_type -> api.v2.InvokeFunctionRequest
	109, // 224: api.v2.V2.ListInsightsTables:input_type -> api.v2.ListInsightsTablesRequest
	116, // 225: api.v2.V2.ListInsightsEventSchemas:input_type -> api.v2.ListInsightsEventSchemasRequest
	113, // 226: api.v2.V2.QueryInsightsPrompt:input_type -> api.v2.QueryInsightsPromptRequest
	102, // 227: api.v2.V2.QueryInsights:input_type -> api.v2.QueryInsightsRequest
	119, // 228: api.v2.V2.ListExperiments:input_type -> api.v2.ListExperimentsRequest
	122, // 229: api.v2.V2.GetExperiment:input_type -> api.v2.GetExperimentRequest
	128, // 230: api.v2.V2.ListSessionKeys:input_type -> api.v2.ListSessionKeysRequest
	131, // 231: api.v2.V2.ListSessions:input_type -> api.v2.ListSessionsRequest
	134, // 232: api.v2.V2.ListSessionRuns:input_type -> api.v2.ListSessionRunsRequest
	13,  // 233: api.v2.V2.Health:output_type -> api.v2.HealthResponse
	16,  // 234: api.v2.V2._SchemaOnly:output_type -> api.v2.ErrorResponse
	61,  // 235: api.v2.V2.CreatePartnerAccount:output_type -> api.v2.CreateAccountResponse
	63,  // 236: api.v2.V2.CreateEnv:output_type -> api.v2.CreateEnvResponse
	67,  // 237: api.v2.V2.FetchPartnerAccounts:output_type -> api.v2.FetchAccountsResponse
	68,  // 238: api.v2.V2.FetchAccount:output_type -> api.v2.FetchAccountResponse
	75,  // 239: api.v2.V2.FetchAccountEnvs:output_type -> api.v2.FetchAccountEnvsResponse
	72,  // 240: api.v2.V2.FetchAccountEventKeys:output_type -> api.v2.FetchAccountEventKeysResponse
	77,  // 241: api.v2.V2.FetchAccountSigningKeys:output_type -> api.v2.FetchAccountSigningKeysResponse
	80,  // 242: api.v2.V2.CreateWebhook:output_type -> api.v2.CreateWebhookResponse
	83,  // 243: api.v2.V2.ListWebhooks:output_type -> api.v2.ListWebhooksResponse
	86,  // 244: api.v2.V2.PatchEnv:output_type -> api.v2.PatchEnvsResponse
	38,  // 245: api.v2.V2.GetFunctionRun:output_type -> api.v2.GetFunctionRunResponse
	139, // 246: api.v2.V2.ListRuns:output_type -> api.v2.ListRunsResponse
	140, // 247: api.v2.V2.ListFunctionRuns:output_type -> api.v2.ListFunctionRunsResponse
	40,  // 248: api.v2.V2.GetEventRuns:output_type -> api.v2.GetEventRunsResponse
	43,  // 249: api.v2.V2.Rerun:output_type -> api.v2.RerunResponse
	142, // 250: api.v2.V2.CancelRun:output_type -> api.v2.CancelRunResponse
	55,  // 251: api.v2.V2.GetApp:output_type -> api.v2.GetAppResponse
	57,  // 252: api.v2.V2.GetApps:output_type -> api.v2.GetAppsResponse
	96,  // 253: api.v2.V2.CreateScore:output_type -> api.v2.CreateScoreResponse
	99,  // 254: api.v2.V2.SyncApp:output_type -> api.v2.SyncAppResponse
	49,  // 255: api.v2.V2.GetFunctionTrace:output_type -> api.v2.GetFunctionTraceResponse
	51,  // 256: api.v2.V2.GetFunction:output_type -> api.v2.GetFunctionResponse
	59,  // 257: api.v2.V2.GetFunctions:output_type -> api.v2.GetFunctionsResponse
	88,  // 258: api.v2.V2.SendEvent:output_type -> api.v2.SendEventResponse
	91,  // 259: api.v2.V2.InvokeFunction:output_type -> api.v2.InvokeFunctionResponse
	110, // 260: api.v2.V2.ListInsightsTables:output_type -> api.v2.ListInsightsTablesResponse
	117, // 261: api.v2.V2.ListInsightsEventSchemas:output_type -> api.v2.ListInsightsEventSchemasResponse
	114, // 262: api.v2.V2.QueryInsightsPrompt:output_type -> api.v2.QueryInsightsPromptResponse
	103, // 263: api.v2.V2.QueryInsights:output_type -> api.v2.QueryInsightsResponse
	120, // 264: api.v2.V2.ListExperiments:output_type -> api.v2.ListExperimentsResponse
	123, // 265: api.v2.V2.GetExperiment:output_type -> api.v2.GetExperimentResponse
	129, // 266: api.v2.V2.ListSessionKeys:output_type -> api.v2.ListSessionKeysResponse
	132, // 267: api.v2.V2.ListSessions:output_type -> api.v2.ListSessionsResponse
	135, // 268: api.v2.V2.ListSessionRuns:output_type -> api.v2.ListSessionRunsResponse
