...
- The **config service**, which manages source keys, function metadata, and action metadata
- The **event service**, which accepts events and publishes them to the messaging system
...
The state systems, queueing systems, and messaging systems must be highly available.  We have multiple
