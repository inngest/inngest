...
You can use the SDK UI to send test events to the CLI which run functions. Enter
your event into the input box and hit send to send the event to Inngest.  Any functions
