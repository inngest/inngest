...
Now, all you need to do is run `inngest deploy --prod` from your function's directory and it will build and push your function live. If you created your Inngest Source in the step above in with “Test” mode enabled in the dashboard, you do not need the `--prod` flag for this command.

<aside>
⭐️ This requires the <a href="/docs/cli/installation?ref=retool-guide">Inngest CLI v0.5.6</a> or greater
</aside>

When you visit the Inngest Cloud dashboard's “Functions” tab, you should see your newly deployed function, ready to receive events!

<aside>
👋 You'll want to take this opportunity to add any necessary environment variables as secrets via the Inngest “Secrets Manager”: <a href="https://app.inngest.com/secrets">app.inngest.com/secrets</a>
</aside>
