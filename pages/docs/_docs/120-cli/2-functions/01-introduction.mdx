...
This allows us to properly inspect the response, plus the classification of function errors. You can read [documentation on function inputs and outputs here](/docs/functions/function-input-and-output).
