...
You can send us events by a single POST request to https://inn.gs/e/$ingestKey. The request body must be your JSON-encoded event, and a maximum of 256KB. On success, the API returns a 201 status code.
