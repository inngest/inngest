...
- `user`: (optional) An object containing [information relating to the user](/docs/events/user-identification) which the event belongs to.  For example, a “payment.succeeded” event should contain information on the user who paid.
