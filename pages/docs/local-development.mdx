...
2. Manually. For apps running in other ports, you’ll need to paste the local URL to connect the app. You can edit the URL or delete a manually added app at any point in time. 
