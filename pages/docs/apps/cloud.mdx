...
# Working with Apps
After deploying your code to your hosted platform, it is time to go to production and inform Inngest about your apps and functions. 
...
1. Navigate to the Apps page in Inngest Cloud. You’ll find a button named “Sync App” or “Sync New App”, depending on whether you already have synced apps or not.
...
Send a PUT request to your application's serve endpoint uding the following command:
...
To ensure that your functions are up-to-date, you need to resync your app with Inngest whenever you deploy new code to your hosted platform.
