...
# Working with Apps
After deploying your code to your hosted platform, it is time to go to production and inform Inngest about your apps and functions. Check what are [Inngest Apps](/docs/apps) if you haven't done it yet.
...
1. Select your environment (e.g. "Production") in Inngest Cloud and navigate to the Apps page. You’ll find a button named “Sync App” or “Sync New App”, depending on whether you already have synced apps or not.
...
You'll need to ensure that the latest version of your code is live on your platform before syncing with Inngest. Some platforms have rolling deploys that take seconds or minutes until the latest version of your code is live.
...
<Callout>
If you are syncing your app through an integration, this process is seamlessly handled for you automatically.
</Callout>
