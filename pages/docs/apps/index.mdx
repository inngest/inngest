...
<Callout>
Each app name is considered a persistent identifier. Changing your client ID will result in Inngest not recognizing the app name during the next sync. As a result, Inngest will create a new app. 
</Callout>
