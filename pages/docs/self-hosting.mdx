...
[architecture docs](https://github.com/inngest/inngest#project-architecture).
...
- [Each end-to-end test has example configuration files](https://github.com/inngest/inngest)
...
reach out to us at [hello@inngest.com](mailto:hello@inngest.com?subject=Self-hosting+Inngest) for more information, or
[speak to us on Discord](/discord).