...
Writing functions is the same no matter what platform you deploy to — so this example can be used for any TypeScript or JavaScript project (such as Next.js, Netlify, or RedwoodJS).
...
export default inngest.createFunction(
  "Import product images",   // The name of your function, used for observability.
  "product.imported", // The event that triggers this function.
...
export default inngest.createScheduledFunction(
  ...
  "0 9 * * MON",         // The cron syntax for the function
...
You can then import this `inngest` client into TODO
...
For a complete reference of the `serve()` handler, <a href="/docs/sdk/serve">view the reference documentation</a>.<br/>
For in-depth guides for particular frameworks, find yours in the navigation under **"Frameworks."**
