...
export default inngest.createScheduledFunction(
  ...
  "TZ=America/New_York 0 9 * * MON",         // The cron syntax for the function.  TZ= is optional.
...
export default inngest.createFunction("Add to Intercom", "app/user.created", ({ event }) => ...);
```
