...
export default function Home() {
  ...
  return (
    <div className="home">
      ...
      <div>
        {/* Content layout */}
        <div className="mx-auto my-28 px-10 lg:px-16 max-w-5xl grid grid-cols-1 lg:grid-cols-[minmax(600px,_1fr)_1fr] gap-8">
          <header>
            <h1 className="mt-2 mb-6 text-3xl sm:text-5xl font-normal leading-tight">
            ...
            <div className="my-10 flex flex-wrap gap-6 justify-start items-center">
              <Button
            ...
            <div className="my-10">
              <h2 className="text-base">Use events to build:</h2>
              <ul className="ml-6 my-2 flex flex-col gap-2 text-sm list-disc">
                {[
                  "Background jobs",
          ...
          <div>
            {/* PLACEHOLDER */}
            <div className="w-full pb-4 min-w-0">
              <div className="hover:bg-slate-800 px-5 py-3.5 bg-slate-800/50 w-full rounded-lg hover:bg-slate-800/80">
                <a href="#">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <span className="text-3xs leading-none">
                      01GGG522ZATDGVQBCND4ZEAS6Z
                    </span>
                    <span className="text-3xs leading-none flex items-center">
                      <svg width="7" height="10">
                        <path
                          d="M1 0c.5523 0 1 .4477 1 1v8c0 .5523-.4477 1-1 1s-1-.4477-1-1V1c0-.5523.4477-1 1-1Zm5 0c.5523 0 1 .4477 1 1v8c0 .5523-.4477 1-1 1s-1-.4477-1-1V1c0-.5523.4477-1 1-1Z"
                          fill="#FB923C"
                          fillRule="evenodd"
                        ></path>
                      </svg>
      ...
      <section>
        ...
        <div className="mx-auto my-28 px-10 lg:px-16 max-w-5xl">
          <header className="my-24 text-center">
            <h2 className="text-4xl">Event-driven, made simple</h2>
        ...
        <div className="mx-auto my-28 px-10 lg:px-16 max-w-5xl">
          ...
          <div>
            ...
            <div
              ...
              style={{
                marginLeft: `${(30 / 1120) * 100}%`,
                marginRight: `${(30 / 1120) * 100}%`,
              }}
            >
              <ul
              ...
              >
                <li className="text-sm">Events appear in real-time</li>
                <li className="text-sm">Stop parsing terminal output</li>
              </ul>
              <ul
                className="pl-6 list-disc"
                style={{ width: `${(370 / 1120) * 100}%` }}
              >
      ...
      <section>
        ...
        <div className="mx-auto my-28 px-10 lg:px-16 max-w-5xl">
          <header className="my-24 text-center">
            <h2 className="text-4xl">Async Is Easy. Just Write Functions.</h2>
            <p className="mx-auto my-4 max-w-md">
              Build anything async - from simple background jobs and to cron
              jobs to multi-step workflows that span hours or days.
            </p>
          </header>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg: gap-y-12">
            <div>
              <img
                src="/assets/homepage/placeholders/event-function-trigger.png"
                className="rounded-md"
              />
            </div>
            <div className="flex flex-col justify-center">
              <h3 className="text-2xl">Use events to trigger functions</h3>
              <p className="my-6">
                Send events from your app, webhooks, or integrations. Use them
                to trigger one or multiple functions.
              </p>
            </div>
            <div>
              <img
                src="/assets/homepage/placeholders/paused-function.png"
                className="rounded-md"
              />
            </div>
            <div className="flex flex-col justify-center">
              <h3 className="text-2xl">Sleep, schedule, delay</h3>
              <p className="my-6">
            ...
            <div>
              <img
                src="/assets/homepage/placeholders/waiting-for-event.png"
                className="rounded-md"
              />
            </div>
            <div className="flex flex-col justify-center">
              ...
              <p className="my-6">
                Run code that waits for additional events to create workflows
                with multiple input events like cart abandonment, sales
                processes, and churn flows.
              </p>
            </div>
            <div>
              <img
                src="/assets/homepage/placeholders/function-retry.png"
                className="rounded-md"
              />
            </div>
            <div className="flex flex-col justify-center">
              <h3 className="text-2xl">Run code, reliably</h3>
              <p className="my-6">
      ...
      <div className="mx-auto my-16 py-10 px-6 md:px-16 max-w-5xl bg-violet-100 rounded-lg">
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-10 gap-12">
          <div className="lg:col-span-4">
            {selected?.description.map((d, idx) => (
              <div key={d.heading}>
