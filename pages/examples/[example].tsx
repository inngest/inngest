...
export default function LibraryExamplePage(props: Props) {
  return (
    <div>
      ...
      <div className="container pb-24 flex items-center justify-center">
        {props.readme ? (
          <div
            className="prose"
      ...
      <Highlights>
        <div className="p-12 max-w-5xl">More examples here</div>
      </Highlights>
      <Footer />
    </div>
  );
...
export const getStaticProps: GetStaticProps = async (ctx) => {
  ...
  return {
    props: {
      id: ctx.params.example,
      description: "Building a thing with a thing", // TODO: Remove
      ...inngestJson,
      readme,
      meta: {
