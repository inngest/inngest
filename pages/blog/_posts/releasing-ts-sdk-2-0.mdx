...
Check out the [v2 migration guide](https://www.inngest.com/docs/sdk/migration) to learn how to upgrade today.
...
We're excited to see what you'll create with v2! Check out the [v2 migration guide](https://www.inngest.com/docs/sdk/migration) to learn how to upgrade today.
