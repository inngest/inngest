...
At Inngest, we use Discord to collaborate across our remote team for all of our communication, including all of our engineering.  There are some good tools out there for centralizing PR discussions into Slack (hi [axolo.co](https://axolo.co)!) which help increase collaboration and efficiency when merging PRs but, unfortunately, there’s a dearth of these tools for Discord.  So we decided to build something using Inngest — and because of our platform it only took an hour to finish.  Best of all, you [can clone the functions](https://www.notion.so/Building-a-PR-collaboration-tool-on-discord-in-an-hour-d0002b2380e5428b8a8763cbb92d9d03) and deploy them for free to your own Discord org.
...
- Create new [threads](https://www.notion.so/Building-a-PR-collaboration-tool-on-discord-in-an-hour-d0002b2380e5428b8a8763cbb92d9d03) in Discord when PRs are opened
...
In order to create these functions we run `inngest init` ([see the docs here](https://www.notion.so/Building-a-PR-collaboration-tool-on-discord-in-an-hour-d0002b2380e5428b8a8763cbb92d9d03)), then walk through the init process to create new functions that are automatically triggered by their respective events.
...
After running `inngest init` we used the [discordgo](https://www.notion.so/Building-a-PR-collaboration-tool-on-discord-in-an-hour-d0002b2380e5428b8a8763cbb92d9d03) library to communicate with the [Discord API using a new bot](https://www.notion.so/Building-a-PR-collaboration-tool-on-discord-in-an-hour-d0002b2380e5428b8a8763cbb92d9d03), allowing us to create and manage threads and comments.
