...
- **Events can be fully typed and versioned** - [We generate TypeScript types for every event](https://www.inngest.com/docs/typescript?ref=blog-vercel-integration) that you sent so you can be confident in the code that you're writing.
...
2. Write functions using the Inngest SDK and serve them to enable Inngest to remotely and securely invoke them  ([docs](https://www.inngest.com/docs/functions?ref=blog-vercel-integration))
3. Add some code to send an event from your application ([docs](https://www.inngest.com/docs/events?ref=blog-vercel-integration))
...
Check out [the Inngest docs](https://www.inngest.com/docs/deploy/vercel?ref=blog-vercel-integration) for more detail on how this works and how to test your functions right along side your existing local development workflow.
