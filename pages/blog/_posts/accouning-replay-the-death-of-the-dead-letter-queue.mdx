...
We call this **Replay**. In other words, it's peace of mind that is included in every single Inngest plan, including the free tier. You can use Replay today in every Inngest account or learn how to use this feature in [our guide](https://www.inngest.com/docs/platform/replay).
