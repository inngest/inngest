...
subtitle: "How to Send Effective and Reliable Emails in Next.js Application"
date: 2023-08-21
author: Joel Hooks
---
...
{CODE} [https://github.com/joelhooks/inngest-resend-example/blob/be5ef88f163c4b0516a85d556fd6268857eb11f4/src/server/auth.ts#L36-L75](https://github.com/joelhooks/inngest-resend-example/blob/be5ef88f163c4b0516a85d556fd6268857eb11f4/src/server/auth.ts#L36-L75)
...
{CODE} [https://github.com/joelhooks/inngest-resend-example/blob/be5ef88f163c4b0516a85d556fd6268857eb11f4/src/inngest/functions/user-created.ts#L37-L74](https://github.com/joelhooks/inngest-resend-example/blob/be5ef88f163c4b0516a85d556fd6268857eb11f4/src/inngest/functions/user-created.ts#L37-L74)
...
It’s not magic. It’s a lot of deep, hard-core, expertly crafted, highly scalable infrastructure, but the joy is that it is an infrastructure **you get to use, not build or maintain simply**.
...
{code} [https://github.com/joelhooks/inngest-resend-example/blob/be5ef88f163c4b0516a85d556fd6268857eb11f4/src/inngest/functions/user-created.ts#L18-L35](https://github.com/joelhooks/inngest-resend-example/blob/be5ef88f163c4b0516a85d556fd6268857eb11f4/src/inngest/functions/user-created.ts#L18-L35)
