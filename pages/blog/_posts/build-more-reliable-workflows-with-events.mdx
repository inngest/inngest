...
Our beta release is out today and can be used with [Inngest Cloud](https://www.inngest.com/sign-up?ref=nav) today - it's free to start using. Come join us on [Discord](/discord) or Github to share feedback or seek support on building out some critical workflows for yourself.
