...
<aside>
  <h2 className="mb-4" style={{fontSize: "1.3rem", marginTop: 0, fontWeight: "normal" }}>
    Announcing our Inngest JavaScript & TypeScript SDK!
  </h2>
  <p>We've just released our SDK with first-class support for Next.js, Vercel, Netlify, and Express since we've first posted this article.</p>
  <p>👉 <strong><a href="/docs/frameworks/nextjs?ref=blog-nextjs">Read our new guide for Next.js</a></strong></p>
</aside>
