...
We're actively developing how you can easily deploy any function that you create to a number of serverless platforms like AWS Lambda or Inngest Cloud without a single change to your code. A true “*lift and shift*.” This gives you the flexibility of where you want your code to run.
