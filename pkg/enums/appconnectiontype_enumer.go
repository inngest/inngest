// Code generated by "enumer -type=AppConnectionType -json -sql -text -gqlgen -transform=snake -trimprefix=AppConnectionType"; DO NOT EDIT.
...
const _AppConnectionTypeName = "serverlessworker"

var _AppConnectionTypeIndex = [...]uint8{0, 10, 16}

const _AppConnectionTypeLowerName = "serverlessworker"
...
func _AppConnectionTypeNoOp() {
	...
	_ = x[AppConnectionTypeWorker-(1)]
}

var _AppConnectionTypeValues = []AppConnectionType{AppConnectionTypeServerless, AppConnectionTypeWorker}
...
var _AppConnectionTypeNameToValueMap = map[string]AppConnectionType{
	...
	_AppConnectionTypeName[10:16]:      AppConnectionTypeWorker,
	_AppConnectionTypeLowerName[10:16]: AppConnectionTypeWorker,
}

var _AppConnectionTypeNames = []string{
	_AppConnectionTypeName[0:10],
	_AppConnectionTypeName[10:16],
}
