// Code generated by "enumer -trimprefix=PartitionType -type=PartitionType -json -text -gqlgen"; DO NOT EDIT.
...
// MarshalGQL implements the graphql.Marshaler interface for PartitionType
func (i PartitionType) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(i.String()))
}

// UnmarshalGQL implements the graphql.Unmarshaler interface for PartitionType
func (i *PartitionType) UnmarshalGQL(value interface{}) error {
	str, ok := value.(string)
	if !ok {
		return fmt.Errorf("PartitionType should be a string, got %T", value)
	}

	var err error
	*i, err = PartitionTypeString(str)
	return err
}
