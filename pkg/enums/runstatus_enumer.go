...
const _RunStatusLowerName = "runningcompletedfailedcancelled"
...
var _RunStatusValues = []RunStatus{RunStatusRunning, RunStatusCompleted, RunStatusFailed, RunStatusCancelled}
