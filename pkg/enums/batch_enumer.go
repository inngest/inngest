...
const _BatchName = "AppendNewFullMaxSizeExists"

var _BatchIndex = [...]uint8{0, 6, 9, 13, 20, 26}

const _BatchLowerName = "appendnewfullmaxsizeexists"
...
var _BatchValues = []Batch{BatchAppend, BatchNew, BatchFull, BatchMaxSize, BatchExists}
...
var _BatchNameToValueMap = map[string]Batch{
	...
	_BatchName[20:26]:      BatchExists,
	_BatchLowerName[20:26]: BatchExists,
}
