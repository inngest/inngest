...
var Attrs = struct {
	...
	// Tracks the timing of saving to the state store for this execution
	StateSaveDuration attr[*time.Duration]
	// Tracks the timing of enqueuing the next step for this execution
	EnqueueDuration attr[*time.Duration]
