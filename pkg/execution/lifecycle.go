...
// scheduling request and actual initial item, including backend-populated fields,
...
type EnqueueLifecycleListener interface {
	OnFunctionEnqueued(context.Context, ScheduleRequest, queue.QueueItem, string)
}
