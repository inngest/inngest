...
func TestDebounce(t *testing.T) {
	...
	shard := redis_state.NewQueueShard(consts.DefaultQueueShardName, unshardedClient.Queue(), queue.ShardAssignmentConfig{}, opts...)
...
func TestJITDebounceMigration(t *testing.T) {
	...
	defaultQueueShard := redis_state.NewQueueShard(consts.DefaultQueueShardName, unshardedClient.Queue(), queue.ShardAssignmentConfig{}, opts...)
	...
	require.NoError(t, err)
	newSystemShard := redis_state.NewQueueShard("new-system", newSystemClusterClient.Queue(), queue.ShardAssignmentConfig{}, opts...)
