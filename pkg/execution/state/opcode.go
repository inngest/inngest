...
type GeneratorMetadata struct {
	Wrapped struct { // Eliminate method name collisions
		...
		Op     meta.MetadataOp   `json:"op"`
		Values meta.RawMetadata  `json:"values"`
	}
}

func (m GeneratorMetadata) Kind() meta.MetadataKind {
	return m.Wrapped.Kind
}

func (m GeneratorMetadata) Op() meta.MetadataOp {
	return m.Wrapped.Op
}

func (m GeneratorMetadata) Serialize() (meta.RawMetadata, error) {
