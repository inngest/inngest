...
// This endpoint is used by the UI to retrieve feature flags, function metadata,
// and server configuration. It must be available in all modes (dev and self-hosted)
// since the bundled UI depends on it.
