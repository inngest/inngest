...
func (r *GetSpansByRunIDRow) GetSpanFragments() string         { return string(r.SpanFragments) }
...
func (r *GetSpansByDebugRunIDRow) GetSpanFragments() string         { return string(r.SpanFragments) }
...
func (r *GetSpansByDebugSessionIDRow) GetSpanFragments() string         { return string(r.SpanFragments) }
