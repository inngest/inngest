...
SELECT id, name, sdk_language, sdk_version, framework, metadata, status, error, checksum, created_at, archived_at, url, is_connect, connection_type FROM apps WHERE archived_at IS NULL
`
...
SELECT id, name, sdk_language, sdk_version, framework, metadata, status, error, checksum, created_at, archived_at, url, is_connect, connection_type FROM apps WHERE id = $1
`
...
SELECT id, name, sdk_language, sdk_version, framework, metadata, status, error, checksum, created_at, archived_at, url, is_connect, connection_type FROM apps WHERE checksum = $1 AND archived_at IS NULL LIMIT 1
`
...
SELECT id, name, sdk_language, sdk_version, framework, metadata, status, error, checksum, created_at, archived_at, url, is_connect, connection_type FROM apps WHERE id = $1 LIMIT 1
`
...
SELECT id, name, sdk_language, sdk_version, framework, metadata, status, error, checksum, created_at, archived_at, url, is_connect, connection_type FROM apps WHERE name = $1 AND archived_at IS NULL LIMIT 1
`
...
SELECT id, name, sdk_language, sdk_version, framework, metadata, status, error, checksum, created_at, archived_at, url, is_connect, connection_type FROM apps WHERE url = $1 AND archived_at IS NULL LIMIT 1
`
...
SELECT id, name, sdk_language, sdk_version, framework, metadata, status, error, checksum, created_at, archived_at, url, is_connect, connection_type FROM apps WHERE archived_at IS NULL AND connection_type = $1
`
...
UPDATE apps SET error = $1 WHERE id = $2 RETURNING id, name, sdk_language, sdk_version, framework, metadata, status, error, checksum, created_at, archived_at, url, is_connect, connection_type
`
...
UPDATE apps SET url = $1 WHERE id = $2 RETURNING id, name, sdk_language, sdk_version, framework, metadata, status, error, checksum, created_at, archived_at, url, is_connect, connection_type
`
...
RETURNING id, name, sdk_language, sdk_version, framework, metadata, status, error, checksum, created_at, archived_at, url, is_connect, connection_type
`
