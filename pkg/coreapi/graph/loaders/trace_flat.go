...
// flat, non-dynamic span tree (DuckDB's inngest.run_trace_spans — see
// docs/plans/007-duckdb-gql-resolvers.md). Unlike convertRunSpanToGQL
// (trace.go), it carries no logic for the old dynamic/fragment-merged
