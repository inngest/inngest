...
Refreshes the TTL on worker capacity during heartbeat.

Output:
  0: No capacity set, nothing to refresh
  1: Successfully refreshed capacity TTL (if counter exists)
...
-- Refresh capacity key TTL Only If It Exists
