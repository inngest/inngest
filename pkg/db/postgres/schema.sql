...
--
-- Name: apps_name_active_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX apps_name_active_key ON public.apps USING btree (name) WHERE ((archived_at IS NULL) AND ((name)::text <> ''::text));
