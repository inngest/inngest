		...
		Traces: []TraceTemplate{
			{
				...
				StartedOffset: new(100 * time.Millisecond),
				EndedOffset:   new(time.Second),
			},
		},
		...
		MetadataProfiles: []MetadataProfile{
			{
				Items: []MetadataTemplateItem{
					...
					{SpanID: "step-1", Scope: "step", StepID: new("step-1"), StepIndex: new(0), StepAttempt: new(1), Kind: "user.custom", IsUser: true, Values: `{"n":1}`, Offset: 150 * time.Millisecond},
					{SpanID: "step-2", Scope: "step", StepID: new("step-2"), StepIndex: new(1), StepAttempt: new(1), Kind: "user.custom", IsUser: true, Values: `{"n":2}`, Offset: 450 * time.Millisecond},
					{SpanID: "step-2", Scope: "step", StepID: new("step-2"), StepIndex: new(1), StepAttempt: new(1), Kind: "inngest.ai", IsUser: false, Values: `{"tokens":10}`, Offset: 460 * time.Millisecond},
				},
			},
		},
	}
...
func TestGenerateSpanTreePreservesRealNestingNotJustRootChildren(t *testing.T) {
	trace := TraceTemplate{
		...
		Spans: []SpanTemplate{
			...
			{SpanID: "step-1", ParentSpanID: new("root"), StartOffset: 100 * time.Millisecond, EndOffset: 500 * time.Millisecond},
			{SpanID: "step-1-extended-trace", ParentSpanID: new("step-1"), StartOffset: 200 * time.Millisecond, EndOffset: 300 * time.Millisecond},
			{SpanID: "step-2", ParentSpanID: new("root"), StartOffset: 500 * time.Millisecond, EndOffset: time.Second},
		},
	}
