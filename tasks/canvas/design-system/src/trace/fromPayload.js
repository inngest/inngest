...
/**
 * A raw GetRun payload from the Dev Server, turned into the events the
 * renderer takes. This is the only thing that knows what a span looks like.
 */
export function eventsFromTrace(j){
  const t=j.run.trace;
