...
export function Trace({ rows, ms, lead, extra = '', under = '', label = '',
                        ...
                        trim = true, compress = true, compressCompute = false, logs = true,
                        multiple, ...opts }) {
  const html = React.useMemo(() => {
    ...
    setFeatures({ trim, compress, compressCompute, logs, multiple });
  ...
  }, [rows, ms, lead, extra, under, label, frame, running, breaks, trim, compress, compressCompute, logs, multiple, opts]);
