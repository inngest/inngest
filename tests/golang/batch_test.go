...
func TestBatchEvents(t *testing.T) {
	...
	_, err := inngestgo.CreateFunction(
		inngestClient,
		inngestgo.FunctionOpts{ID: "batch-test", BatchEvents: &inngestgo.FnBatchEvents{MaxSize: 5, Timeout: time.Second * 5}},
...
func TestBatchEventsWithKeys(t *testing.T) {
	...
	_, err := inngestgo.CreateFunction(
		inngestClient,
		inngestgo.FunctionOpts{ID: "batch-test", Name: "batch test", BatchEvents: &inngestgo.FnBatchEvents{MaxSize: 3, Timeout: time.Second * 5, Key: &batchKey}},
