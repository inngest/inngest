...
func TestSystemQueueConfigs(t *testing.T) {
	...
	shard := redis_state.NewQueueShard(consts.DefaultQueueShardName, consts.DefaultQueueShardName, 1, redis_state.NewQueueClient(rc, redis_state.QueueDefaultKey), opts...)
