...
export default function ActionBar({ tabs, actions }: ActionBarProps) {
  return (
    <div className="col-span-2 row-start-2 col-start-1 bg-slate-950/50 relative z-20 backdrop-blur-md border-b border-slate-800/60 flex flex-row justify-between">
