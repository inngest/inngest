  ...
  learnMore: {
    ...
    resources: [
      ...
      },
      {
        ...
        description: 'Run code in parallel with automatic retries on serverless or a server.',
        type: 'Docs',
        href: '/docs/guides/step-parallelism',
      },
      {
        title: 'Building an Event Driven Video Processing Workflow with Next.js, tRPC, and Inngest',
        description:
