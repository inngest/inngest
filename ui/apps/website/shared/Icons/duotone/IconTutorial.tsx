...
export function IconTutorial({ size = 20, className = '', color = 'transparent' }) {
  const theme = IconTheme(color);

  return (
    <svg width={size} height={size} className={className} viewBox="0 0 20 20" version="1.1">
      <defs>
        <path
      ...
      <g id="Tutorial" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <path
