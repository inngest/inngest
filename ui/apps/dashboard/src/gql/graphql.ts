...
export type ApiKey = {
  ...
  createdByViewer: Scalars['Boolean']['output'];
  env: Maybe<Workspace>;
  envScope: Scalars['String']['output'];
  envs: Array<Workspace>;
...
export type CreateApiKeyInput = {
  ...
  name: Scalars['String']['input'];
  workspaceID?: InputMaybe<Scalars['UUID']['input']>;
  workspaceIDs?: InputMaybe<Array<Scalars['UUID']['input']>>;
};
...
export type GetApiKeyGrantsQuery = { __typename?: 'Query', apiKeyGrants: Array<{ __typename?: 'APIKeyGrant', grant: string, name: string, action: string, description: string, category: string, sensitive: boolean }>, account: { __typename?: 'Account', memberAPIKeyPolicy: { __typename?: 'MemberAPIKeyPolicy', enabled: boolean, allowProduction: boolean, grants: Array<string> } } };
...
export type GetApiKeysQuery = { __typename?: 'Query', account: { __typename?: 'Account', apiKeys: Array<{ __typename?: 'APIKey', id: string, name: string, createdAt: string, maskedKey: string, grants: Array<string>, envScope: string, createdByViewer: boolean, scopes: Array<{ __typename?: 'APIKeyScope', name: string, allow: Array<string> }>, envs: Array<{ __typename?: 'Workspace', id: string, name: string }>, env: { __typename?: 'Workspace', id: string, name: string, slug: string } | null, createdBy: { __typename?: 'User', id: string, name: null | string | null, email: string } | null }> } };
