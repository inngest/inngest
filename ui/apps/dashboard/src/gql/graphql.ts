...
export type SdkFeatureReadiness = {
  ...
  aiMetadataExtraction: Maybe<SdkFeatureReadinessFeature>;
  extendedTraces: Maybe<SdkFeatureReadinessFeature>;
};

export type SdkFeatureReadinessFeature = {
  __typename?: 'SDKFeatureReadinessFeature';
  readinessReason: Scalars['Int']['output'];
};
