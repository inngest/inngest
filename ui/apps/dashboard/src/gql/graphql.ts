...
export type AppsQuery = { __typename?: 'Query', environment: { __typename?: 'Workspace', apps: Array<{ __typename?: 'App', id: string, externalID: string, name: string, functions: Array<{ __typename?: 'Workflow', id: string }>, latestSync: { __typename?: 'Deploy', createdAt: string, framework: string | null, id: string, platform: string | null, sdkLanguage: string, sdkVersion: string, status: string, url: string | null } | null }> } };
