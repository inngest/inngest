...
export type GetReplaysQuery = { __typename?: 'Query', environment: { __typename?: 'Workspace', id: string, function: { __typename?: 'Workflow', id: string, replays: Array<{ __typename?: 'Replay', id: string, name: string, createdAt: string, endedAt: string | null, functionRunsScheduledCount: number, functionRunsProcessedCount: number, filters: null | boolean | number | string | Record<string, unknown> | unknown[] | null }> } | null } };
