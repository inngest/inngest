...
export type ExecutionLimitCheckQuery = { __typename?: 'Query', account: { __typename?: 'Account', id: string, marketplaceBillingURL: string | null, plan: { __typename?: 'BillingPlan', id: string, name: string } | null, entitlements: { __typename?: 'Entitlements', executions: { __typename?: 'EntitlementExecutions', usage: number, limit: number | null, overageAllowed: boolean } } } };
