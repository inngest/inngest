...
export type GetRestrictedApiKeysQuery = { __typename?: 'Query', v2RestrictedAuth: boolean, apiCredentials: { __typename?: 'APICredentialPage', hasMore: boolean, keys: Array<{ __typename?: 'APICredential', id: string, name: string, maskedKey: string, permissions: Array<string>, createdAt: string, expiresAt: string, revokedAt: string | null, env: { __typename?: 'Workspace', id: string, name: string } | null }> }, apiCredentialPermissionCatalog: Array<{ __typename?: 'APICredentialPermissionGroup', resource: string, read: Array<string>, write: Array<string> }> };
...
export type ExecutionLimitCheckQuery = { __typename?: 'Query', account: { __typename?: 'Account', id: string, marketplaceBillingURL: string | null, entitlements: { __typename?: 'Entitlements', executions: { __typename?: 'EntitlementExecutions', usage: number, limit: number | null, overageAllowed: boolean } } } };
...
export type GetCurrentPlanQuery = { __typename?: 'Query', account: { __typename?: 'Account', plan: { __typename?: 'BillingPlan', id: string, slug: string, isLegacy: boolean, isFree: boolean, name: string, amount: number, billingPeriod: unknown, entitlements: { __typename?: 'Entitlements', concurrency: { __typename?: 'EntitlementConcurrency', limit: number }, events: { __typename?: 'EntitlementEvents', limit: number | null }, eventSize: { __typename?: 'EntitlementInt', limit: number }, functionBacklogSize: { __typename?: 'EntitlementNullableInt', limit: number | null }, history: { __typename?: 'EntitlementInt', limit: number }, runCount: { __typename?: 'EntitlementRunCount', limit: number | null }, stepCount: { __typename?: 'EntitlementStepCount', limit: number | null }, userCount: { __typename?: 'EntitlementUserCount', limit: number | null } }, addons: { __typename?: 'Addons', concurrency: { __typename?: 'Addon', available: boolean, baseValue: number | null, maxValue: number, name: string, price: number | null, purchaseCount: number, quantityPer: number }, userCount: { __typename?: 'Addon', available: boolean, price: number | null, purchaseCount: number, quantityPer: number }, slackChannel: { __typename?: 'Addon', available: boolean, price: number | null, purchaseCount: number, quantityPer: number }, connectWorkers: { __typename?: 'Addon', available: boolean, price: number | null, purchaseCount: number, quantityPer: number } } } | null, entitlements: { __typename?: 'Entitlements', concurrency: { __typename?: 'EntitlementConcurrency', limit: number }, events: { __typename?: 'EntitlementEvents', limit: number | null }, functionBacklogSize: { __typename?: 'EntitlementNullableInt', limit: number | null } }, addons: { __typename?: 'Addons', concurrency: { __typename?: 'Addon', available: boolean, baseValue: number | null, maxValue: number, name: string, price: number | null, purchaseCount: number, quantityPer: number } }, paymentMethods: Array<{ __typename?: 'PaymentMethod', default: boolean }> | null, subscription: { __typename?: 'BillingSubscription', nextInvoiceDate: string } | null } };
...
export type GetPlansQuery = { __typename?: 'Query', plans: Array<{ __typename?: 'BillingPlan', id: string, slug: string, isLegacy: boolean, isFree: boolean, name: string, amount: number, billingPeriod: unknown, addons: { __typename?: 'Addons', concurrency: { __typename?: 'Addon', available: boolean, baseValue: number | null, maxValue: number, name: string, price: number | null, purchaseCount: number, quantityPer: number } }, entitlements: { __typename?: 'Entitlements', concurrency: { __typename?: 'EntitlementConcurrency', limit: number }, eventSize: { __typename?: 'EntitlementInt', limit: number }, history: { __typename?: 'EntitlementInt', limit: number }, executions: { __typename?: 'EntitlementExecutions', limit: number | null }, runCount: { __typename?: 'EntitlementRunCount', limit: number | null }, stepCount: { __typename?: 'EntitlementStepCount', limit: number | null } } }> };
