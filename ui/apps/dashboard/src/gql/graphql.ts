...
export type AppsQuery = { __typename?: 'Query', environment: { __typename?: 'Workspace', apps: Array<{ __typename?: 'App', id: string, externalID: string, functionCount: number, isArchived: boolean, name: string, connectionType: AppConnectionType, latestSync: { __typename?: 'Deploy', error: string | null, framework: string | null, id: string, lastSyncedAt: string, platform: string | null, sdkLanguage: string, sdkVersion: string, status: string, url: string | null } | null, functions: Array<{ __typename?: 'Workflow', id: string, name: string }> }>, unattachedSyncs: Array<{ __typename?: 'Deploy', lastSyncedAt: string }> } };
