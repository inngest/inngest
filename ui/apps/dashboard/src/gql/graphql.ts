...
export type GetFunctionQuery = { __typename?: 'Query', workspace: { __typename?: 'Workspace', id: string, workflow: { __typename?: 'Workflow', id: string, name: string, slug: string, isArchived: boolean, appName: string | null, url: string, current: { __typename?: 'WorkflowVersion', workflowID: string, version: number, config: string, retries: number, validFrom: string | null, validTo: string | null, description: null | string | null, updatedAt: string, triggers: Array<{ __typename?: 'WorkflowTrigger', eventName: null | string | null, schedule: null | string | null }>, deploy: { __typename?: 'Deploy', id: string, createdAt: string } | null } | null } | null } };
