...
export type ConstraintApiEnrollmentQueryVariables = Exact<{ [key: string]: never; }>;


export type ConstraintApiEnrollmentQuery = { __typename?: 'Query', account: { __typename?: 'Account', id: string, constraintAPIEnrolled: boolean } };

export type ConstraintApiInEffectQueryVariables = Exact<{ [key: string]: never; }>;


export type ConstraintApiInEffectQuery = { __typename?: 'Query', account: { __typename?: 'Account', id: string, constraintAPIEnrolled: boolean } };

export type EnrollToConstraintApiMutationVariables = Exact<{ [key: string]: never; }>;


export type EnrollToConstraintApiMutation = { __typename?: 'Mutation', enrollToConstraintAPI: boolean };
...
export const ConstraintApiEnrollmentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ConstraintAPIEnrollment"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"account"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"constraintAPIEnrolled"}}]}}]}}]} as unknown as DocumentNode<ConstraintApiEnrollmentQuery, ConstraintApiEnrollmentQueryVariables>;
export const ConstraintApiInEffectDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ConstraintAPIInEffect"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"account"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"constraintAPIEnrolled"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"inEffect"},"value":{"kind":"BooleanValue","value":true}}]}]}}]}}]} as unknown as DocumentNode<ConstraintApiInEffectQuery, ConstraintApiInEffectQueryVariables>;
export const EnrollToConstraintApiDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"EnrollToConstraintAPI"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"enrollToConstraintAPI"}}]}}]} as unknown as DocumentNode<EnrollToConstraintApiMutation, EnrollToConstraintApiMutationVariables>;
