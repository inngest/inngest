...
export type GetSavedVercelProjectsQuery = { __typename?: 'Query', environment: { __typename?: 'Workspace', savedVercelProjects: Array<{ __typename?: 'VercelApp', id: string, projectID: string, path: string | null, workspaceID: string, originOverride: string | null, protectionBypassSecret: string | null }> } };
