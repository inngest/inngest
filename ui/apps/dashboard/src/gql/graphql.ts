...
export type GetDatadogIntegrationQueryVariables = Exact<{
  workspaceID: Scalars['ID'];
}>;


export type GetDatadogIntegrationQuery = { __typename?: 'Query', workspace: { __typename?: 'Workspace', datadogIntegration: { __typename?: 'DatadogIntegration', id: string, datadogSite: string, appKey: string, appKeyUpdatedAt: string, apiKey: string, apiKeyUpdatedAt: string } | null } };

export type ListDatadogIntegrationsQueryVariables = Exact<{ [key: string]: never; }>;


export type ListDatadogIntegrationsQuery = { __typename?: 'Query', account: { __typename?: 'Account', datadogIntegrations: Array<{ __typename?: 'DatadogIntegration', id: string, accountID: string, envID: string, datadogSite: string, appKey: string, appKeyUpdatedAt: string, apiKey: string, apiKeyUpdatedAt: string, lastSentAt: string | null, createdAt: string, updatedAt: string | null, statusOk: boolean }> } };

export type SetupDatadogIntegrationMutationVariables = Exact<{
  workspaceID: Scalars['UUID'];
  apiKey: Scalars['String'];
  appKey: Scalars['String'];
...
export type SetupDatadogIntegrationMutation = { __typename?: 'Mutation', setupDatadogIntegration: { __typename?: 'DatadogIntegrationSetupResponse', error: string | null, integration: { __typename?: 'DatadogIntegration', id: string } | null } | null };
