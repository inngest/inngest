...
export type GetApiKeyDetailQuery = { __typename?: 'Query', account: { __typename?: 'Account', apiKey: { __typename?: 'APIKey', id: string, name: string, createdAt: string, resourceBoundaryMode: ApiKeyResourceBoundaryMode, expiresAt: string | null, credentialSource: ApiKeyCredentialSource, maskedKey: string, permissionGrants: Array<string>, env: { __typename?: 'Workspace', id: string, name: string, type: EnvironmentType } | null, scopes: Array<{ __typename?: 'APIKeyScope', name: string, allow: Array<string>, deny: Array<string> }> } }, apiKeyPermissionCatalog: Array<{ __typename?: 'APIKeyPermissionGroup', resource: string, label: string, description: string | null, read: Array<string>, write: Array<string> }> };
