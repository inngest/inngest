...
export type GetRunsQuery = { __typename?: 'Query', environment: { __typename?: 'Workspace', runs: { __typename?: 'RunsConnection', edges: Array<{ __typename?: 'FunctionRunV2Edge', node: { __typename?: 'FunctionRunV2', cronSchedule: string | null, eventName: string | null, id: string, isBatch: boolean, queuedAt: string, endedAt: string | null, startedAt: string | null, status: FunctionRunStatus, hasAI: boolean, runType: RunType, app: { __typename?: 'App', externalID: string, name: string }, function: { __typename?: 'Workflow', name: string, slug: string }, deferredFrom: { __typename?: 'RunDeferredFrom', parentRun: { __typename?: 'FunctionRunV2', function: { __typename?: 'Workflow', name: string, slug: string } } | null } | null } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null } } } };
...
export type GetRunLinkageQuery = { __typename?: 'Query', workspace: { __typename?: 'Workspace', run: { __typename?: 'FunctionRunV2', defers: Array<{ __typename?: 'RunDefer', id: string, userDeferID: string, fnSlug: string, status: RunDeferStatus, run: { __typename?: 'FunctionRunV2', id: string, status: FunctionRunStatus, function: { __typename?: 'Workflow', name: string, slug: string } } | null }>, deferredFrom: { __typename?: 'RunDeferredFrom', parentRunID: string, parentRun: { __typename?: 'FunctionRunV2', id: string, status: FunctionRunStatus, function: { __typename?: 'Workflow', name: string, slug: string }, defers: Array<{ __typename?: 'RunDefer', id: string, userDeferID: string, fnSlug: string, status: RunDeferStatus, run: { __typename?: 'FunctionRunV2', id: string, status: FunctionRunStatus, function: { __typename?: 'Workflow', name: string, slug: string } } | null }> } | null } | null, invokedFrom: { __typename?: 'RunInvokedFrom', parentRunID: string, stepName: string | null, parentRun: { __typename?: 'FunctionRunV2', id: string, status: FunctionRunStatus, function: { __typename?: 'Workflow', name: string, slug: string } } | null } | null } | null } };
