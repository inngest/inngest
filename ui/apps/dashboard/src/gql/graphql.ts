...
export type GetApiKeysQuery = { __typename?: 'Query', account: { __typename?: 'Account', apiKeys: Array<{ __typename?: 'APIKey', id: string, name: string, createdAt: string, maskedKey: string, scopes: Array<{ __typename?: 'APIKeyScope', name: string, allow: Array<string> }>, env: { __typename?: 'Workspace', id: string, name: string, slug: string } | null, createdBy: { __typename?: 'User', id: string, name: null | string | null, email: string } | null }> } };
