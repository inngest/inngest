...
export type SyncedFunctionConfig = {
  __typename?: 'SyncedFunctionConfig';
  concurrency: Maybe<Array<ConcurrencyConfiguration>>;
  functionVersion: Scalars['Int'];
  id: Scalars['ID'];
  name: Scalars['String'];
  slug: Scalars['String'];
...
export type Workflow = {
  ...
  latestSyncedConfig: Maybe<SyncedFunctionConfig>;
