...
export type EntitlementUsageQuery = { __typename?: 'Query', account: { __typename?: 'Account', id: string, entitlementUsage: { __typename?: 'EntitlementUsage', runCount: { __typename?: 'EntitlementUsageRunCount', current: number, limit: number | null } } } };
...
export type GetVercelAppsQuery = { __typename?: 'Query', environment: { __typename?: 'Workspace', unattachedSyncs: Array<{ __typename?: 'Deploy', lastSyncedAt: string, error: string | null }>, vercelApps: Array<{ __typename?: 'VercelApp', id: string, projectID: string, path: string | null, originOverride: string | null }>, apps: Array<{ __typename?: 'App', id: string, externalID: string, latestSync: { __typename?: 'Deploy', error: string | null, id: string, platform: string | null, vercelDeploymentID: string | null, vercelProjectID: string | null, status: string } | null }> } };
