...
export type GetFunctionArchivalQuery = { __typename?: 'Query', workspace: { __typename?: 'Workspace', workflow: { __typename?: 'Workflow', id: string, isArchived: boolean, isParentArchived: boolean, name: string } | null } };
