    ...
    <ClerkProvider
      appearance={{
        ...
        elements: {
          ...
          alert__warning:
            'border-warning bg-warning hover:border-warning shadow-none',
          menuList: 'shadow-none bg-canvasBase border-muted border',
          menuItem: 'hover:bg-canvasSubtle',
          selectOptionsContainer:
            'shadow-none bg-canvasBase border-muted border',
          ...
          tagPillContainer:
            'bg-canvasMuted text-basis shadow-none hover:bg-surfaceMuted', // Pill component solid default styles
          ...
          profileSectionTitleText__activeDevices:
            'sticky top-0 bg-canvasBase z-10',
          ...
          tagInputContainer:
            'border-0 shadow-none bg-transparent *:px-3 *:p-1.5 *:text-sm',
