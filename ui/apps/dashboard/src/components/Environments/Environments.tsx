...
import { EnvironmentArchiveButton } from '@/app/(organization-active)/(dashboard)/env/EnvironmentArchiveButton';
import EnvironmentListTable from '@/app/(organization-active)/(dashboard)/env/EnvironmentListTable';
