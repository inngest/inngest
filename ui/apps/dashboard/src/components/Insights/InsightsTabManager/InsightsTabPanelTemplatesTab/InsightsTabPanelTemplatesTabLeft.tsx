...
interface InsightsTabPanelTemplatesTabLeftProps {
  tabManagerActions: TabManagerActions;
}

export function InsightsTabPanelTemplatesTabLeft({
  tabManagerActions,
}: InsightsTabPanelTemplatesTabLeftProps) {
  return (
    <div className="flex flex-1 flex-col">
      ...
      <InsightsTabPanelTemplatesTabGrid tabManagerActions={tabManagerActions} />
    </div>
  );
}
