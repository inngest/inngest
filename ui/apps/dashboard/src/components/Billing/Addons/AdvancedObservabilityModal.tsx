            ...
            <div className="space-y-2 p-6">
              ...
              <div className="p-2">
                <div className="border-subtle pb-2">
                  <h3 className="text-basis text-md font-semibold">Advanced Observability</h3>
                </div>
                ...
                <div className="">
                  <div className="flex flex-col justify-between border-y py-2">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-basis text-sm font-medium">30 days</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-between border-b py-3">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-basis text-sm font-medium">1 minute</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-between border-b py-3">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-basis text-sm font-medium">5 minutes</span>
                    </div>
                  </div>
                </div>
