...
import { DEFAULT_POLL_INTERVAL } from '@/components/Runs/Runs';
...
export function SessionRuns({
  ...
  // Track expanded rows by ID, like RunsTable, so refetches can't shift
  // an expansion onto a different row.
  ...
  // The sessionRuns query has no status argument, so filter client-side.
