...
import { CancelFunctionButton } from '@/components/Functions/CancelFunction';
import PauseFunctionButton from '@/components/Functions/PauseFunction/PauseButton';
...
export default function OldFunctionLayout({ children, params }: FunctionLayoutProps) {
