      ...
      {fetching ? null : !project ? (
        ...
        <div className="flex flex-col">
          ...
          {project.ssoProtection?.deploymentType ===
            ...
            <div className="mb-7 flex flex-row items-center justify-start text-sm font-normal leading-snug text-yellow-700">
              <RiInformationLine className="mr-2 h-4 w-4 text-yellow-700" />
          ...
          <div className="flex flex-row gap-4">
            <div className="mt-4 flex w-full flex-col gap-2 rounded-lg border border-slate-200 p-6">
              ...
              <Input className="mt-4 h-10 px-2 py-2 text-base text-gray-900" />
            </div>
            <div className="mt-4 flex w-full flex-col gap-2 rounded-lg border border-slate-200 p-6">
          ...
          <div>
            <NewButton label="Save configuration" className="mt-6" />
          </div>
        </div>
      )}
    </div>
