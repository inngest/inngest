...
test.describe('Dashboard - Configuration Test', () => {
  ...
  test('Browser capabilities work', async ({ page }) => {
    await page.goto(
      'data:text/html,<html><body><h1>Dashboard Test</h1></body></html>',
    );

    // Test basic selectors and assertions work
    await expect(page.locator('h1')).toHaveText('Dashboard Test');
