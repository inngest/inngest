    ...
    <div className="flex h-full flex-col overflow-y-scroll">
      ...
      <div className="mx-auto w-full max-w-4xl px-6 pb-4 pt-16">
        ...
        <p className="text-subtle text-sm">
          Apps can be synced manually with the CLI's <InlineCode>-u</InlineCode>{' '}
          flag, a config file, the button below, or via auto-discovery.{' '}
          <Link
            target="_blank"
            size="small"
            className="inline"
            ...
            {info?.isDiscoveryEnabled && (
              <div className="text-light flex items-center gap-1">
                ...
                <p className="text-sm">
                  ...
                  <InlineCode>--no-discovery</InlineCode> flag in your CLI to
                  disable it.{' '}
                  <Link
                    target="_blank"
                    size="small"
        ...
        <div className="my-6 flex w-full flex-col gap-10">
          {memoizedAppCards}
        </div>
