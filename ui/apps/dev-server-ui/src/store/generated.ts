...
export type GetEventPayloadQuery = { __typename?: 'Query', eventV2: { __typename?: 'EventV2', raw: string } };
...
export const GetEventPayloadDocument = `
    query GetEventPayload($eventID: ULID!) {
  eventV2(id: $eventID) {
    raw
  }
}
