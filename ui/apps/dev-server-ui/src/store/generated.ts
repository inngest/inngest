...
export type RunTraceSpan = {
  ...
  metadata: Array<RunTraceSpanMetadata>;
  name: Scalars['String'];
...
export type RunTraceSpanMetadata = {
  __typename?: 'RunTraceSpanMetadata';
  kind: Scalars['String'];
  values: Array<RunTraceSpanMetadataValue>;
};

export type RunTraceSpanMetadataValue = {
  __typename?: 'RunTraceSpanMetadataValue';
  key: Scalars['String'];
