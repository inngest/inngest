...
export function renderCell(
  ...
  switch (type) {
    ...
    default:
      // A column typed String/Number/Boolean/Unknown can still carry a
      // real object or array value -- e.g. a VARIANT column the backend
      // reports as Unknown when it can't statically infer a tighter type.
      // String(value) on those produces "[object Object]"/
      // "value1,value2,..." rather than useful text, so render them like a
      // Json column instead of falling through to the plain-text case.
