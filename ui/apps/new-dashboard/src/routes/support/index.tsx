...
export const Route = createFileRoute("/support/")({
  ...
  validateSearch: (search: Record<string, unknown>) => {
    return {
      q: search.q as TicketType | undefined,
    };
  },
});
...
function SupportComponent() {
  ...
  const { q: preselectedTicketType } = useSearch({
    strict: false,
  });
    ...
    <div className="h-full overflow-y-scroll">
      <div className="mx-auto max-w-screen-xl px-6">
        <div className="my-4 inline-block">
          <Button
            to={import.meta.env.VITE_HOME_PATH}
            size="small"
            appearance="outlined"
            kind="secondary"
            ...
            {fetching ? (
              ...
              <>
                ...
                <div className="flex gap-2">
                  <Button
                    kind="primary"
                    href={`${import.meta.env.CLERK_SIGN_IN_URL}?ref=support`}
                    label="Sign In"
                  />
                  <Button
                    kind="primary"
                    href={`${import.meta.env.CLERK_SIGN_UP_URL}?ref=support`}
                    label="Sign Up"
                  />
                </div>
              </>
              ...
              <>
                <SupportForm
                  ...
                  isPaid={isPaid}
                  preselectedTicketType={preselectedTicketType ?? null}
                />
