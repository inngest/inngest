...
// @generated from file third_party/protoc-gen-openapiv2/options/annotations.proto (package grpc.gateway.protoc_gen_openapiv2.options, syntax proto3)
...
import {
  file_third_party_protoc_gen_openapiv2_options_openapiv2,
  type EnumSchema,
  type JSONSchema,
  type Operation,
  type Schema,
...
export const openapiv2_swagger: GenExtension<FileOptions, Swagger> =
  /*@__PURE__*/
  extDesc(file_third_party_protoc_gen_openapiv2_options_annotations, 0);
...
export const openapiv2_operation: GenExtension<MethodOptions, Operation> =
  /*@__PURE__*/
  extDesc(file_third_party_protoc_gen_openapiv2_options_annotations, 1);
...
export const openapiv2_schema: GenExtension<MessageOptions, Schema> =
  /*@__PURE__*/
  extDesc(file_third_party_protoc_gen_openapiv2_options_annotations, 2);
 ...
 */
export const openapiv2_enum: GenExtension<EnumOptions, EnumSchema> =
  /*@__PURE__*/
  extDesc(file_third_party_protoc_gen_openapiv2_options_annotations, 3);
...
export const openapiv2_tag: GenExtension<ServiceOptions, Tag> =
  /*@__PURE__*/
  extDesc(file_third_party_protoc_gen_openapiv2_options_annotations, 4);
...
export const openapiv2_field: GenExtension<FieldOptions, JSONSchema> =
  /*@__PURE__*/
  extDesc(file_third_party_protoc_gen_openapiv2_options_annotations, 5);
