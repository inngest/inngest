...
type HelperPanelControlProps = {
  activeTitle: null | string;
  items: HelperItem[];
};

export function HelperPanelControl({ activeTitle, items }: HelperPanelControlProps) {
  return (
      ...
      {items.map((item) => {
        ...
        const content = (
          <>
            ...
            <div className="text-subtle max-w-full px-1 text-center text-[9px] font-medium leading-tight">
