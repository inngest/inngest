//
// This is from https://github.com/date-fns/date-fns/pull/3151
// It was supposed to land in 3.0 but didn't make, once it lands

import type { Duration } from 'date-fns';

// we can call direction from date-fns
