...
export function MetadataGrid({ metadataItems, columns = 3 }: Props) {
  ...
  return (
    <div className="dark:bg-slate-910 rounded-lg border border-slate-200 bg-white p-2.5 dark:border-slate-800/50">
      <div className={`grid grid-cols-${gridColumns} grid-rows-${rows} gap-5`}>
