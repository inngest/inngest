...
export const getButtonColors = ({ kind, appearance }: ButtonColorParams) => {
  ...
  const outlinedButtonStyles = {
    default:
      'bg-slate-800/20 border border-slate-800/80 hover:border-slate-800 text-slate-200 hover:text-white',
    primary:
      'bg-indigo-500/20 border border-indigo-500/80 hover:border-indigo-500 text-slate-200 hover:text-white',
    success:
      'bg-emerald-600/20 border border-emerald-600/80 hover:border-emerald-600 text-slate-200 hover:text-white',
    danger:
      'bg-rose-700/20 border border-rose-700/80 hover:border-rose-700 text-slate-200 hover:text-white',
  };
