...
<div style={{ padding: '3rem 1rem' }} className="dark:bg-slate-940 bg-white">
  <p className="text-slate-500 dark:text-white font-semibold">Primary</p>
  <div className="align-center items-center flex gap-1 pb-4">
    <p className="text-slate-500 dark:text-white pr-2">Solid appearance:</p>
  ...
  <div className="align-center items-center flex gap-1 pb-4">
    <p className="text-slate-500 dark:text-white pr-2">Outlined appearance:</p>
  ...
  <div className="align-center items-center flex gap-1 pb-4">
    <p className="text-slate-500 dark:text-white pr-2">Ghost appearance:</p>
  ...
  <p className="text-slate-500 dark:text-white font-semibold">Secondary</p>
  ...
  <p className="text-slate-500 dark:text-white font-semibold">Danger</p>
  <div className="align-center items-center flex gap-1 pb-4">
    <p className="text-slate-500 dark:text-white pr-2">Solid appearance:</p>
